...
export const level9 = {
  ...
  description:
    "You can strum and sing individual notes. Now create original melodic phrases using the chord tones from Level 2. Start with 2-note phrases, grow to 4-note melodies, then string them into a simple song sketch. Everything is YOUR creation — no covers, no imitation. But first, five songwriting-readiness exercises sharpen your analytical ear and build the capture-and-draft habits that make composing sustainable. The embodiment cycle now sustains across entire song structures: in a verse, the hear-feel-choose cycle operates phrase by phrase. In a chorus, it operates on the emotional arc. Your body tells you when the chorus NEEDS to arrive — there's a physical sensation of building tension that demands release. And when you compose, the cycle runs in reverse: you choose the feeling the song needs, feel where it lives, hear the melody that carries it, and produce it. Based on Orff's 'create before you analyze' and Kratus's first improvisation level: exploration within constraints.",
  ...
  exercises: [
    ...
    },
    {
      ...
      feel: "Good prosody should feel like the words and melody were made for each other — the melody makes the words sound BETTER than spoken, not worse. If it feels natural, the prosody is working. You'll feel it in your body: when stress and beat align, the breath supports the stressed syllable naturally, the resonance opens on the important word, and the body leans into the meaning. When they misalign, there's a physical awkwardness — a catch in the breath, a forced resonance. Trust the body's signal.",
    ...
    },
    {
      ...
      steps: [
        { text: "Seed 1 — MELODY: Close your eyes for 5 seconds. Hear a melody fragment forming inside — feel where it gathers in the body, which resonance stations it wants to visit. When the pitch and body-path are both vivid, let it out: hum or sing it (4-8 notes). Record immediately. Tag it: 'melody seed, [mood word], [date].' Under 30 seconds.", why: "Speed matters more than quality — but audiating the melody first means you're capturing what your inner ear composed, not what your voice happened to produce. Play nothing you didn't hear first. Professional songwriters like Dan Wilson maintain thousands of voice memos. The discipline is CAPTURE, not perfection." },
      ...
      feel: "This should feel fast and low-pressure — capture speed, not recording quality. A voice memo recorded in a parking lot is more valuable than a perfect idea you forgot because you didn't record it. When a melody fragment arrives, notice: it arrives as a body sensation first — a resonance pattern, a breath shape, a physical urge to vocalize. The hear-feel-choose cycle runs in a flash: the idea emerges from the body before the mind names it. Capture THAT moment. Speed matters because the body-sensation fades faster than the pitch memory.",
    ...
    },
    {
      ...
      feel: "This should feel uncomfortable and freeing at the same time — uncomfortable because it's imperfect, freeing because you're creating without judgment. The timer is your permission slip to be bad. Notice: when you stop judging and start creating, the hear-feel-choose cycle runs faster and looser than it ever has. Your body leads — you hum before you think, your chest resonance finds a note before your ear names it, your breath shapes a phrase before your mind plans it. This is the embodiment cycle at full speed, powering raw creation. Trust it.",
      wrong: "If you restart, you've broken the exercise. If you stop to 'think of something better,' you've broken the exercise. If you judge a line and discard it, you've broken the exercise. KEEP GOING. Ugly is the goal. Edit LATER. If this feels uncomfortable, that's the productive discomfort zone — it means your taste exceeds your current output. The gap closes through volume, not through being more careful.",
      sarah: "Gene, Ira Glass said it best: 'Your taste is good enough to tell that what you're making isn't great yet. The gap closes through VOLUME of work, not through being more careful.' This exercise is volume. Write ugly songs every week. Watch what happens. You're not learning to be a songwriter — you already ARE one. This is just the first draft of many.",
      metronome: 80,
...

    {
      ...
      steps: [
        { text: "Strum Am on autopilot. Sing the root A — feel it settle deep in the chest, grounded and warm. Hold for 2 beats. Now the 5th E — feel the vibration lift toward the upper chest, opening. Hold for 2 beats. Two notes, two body addresses, a simple journey between depth and openness.", why: "Two notes is the minimum for a melody AND the minimum body journey. A (chest-depth) to E (upper-chest-openness) creates a physical arc that mirrors the melodic arc. Starting here removes overwhelm while establishing the embodiment cycle: hear each note, feel its body address, produce it." },
        { text: "Now vary the rhythm: try A (1 beat) - E (3 beats). You spend most of your time in E's upper openness. Then A (3 beats) - E (1 beat) — most of the time in A's chest warmth. Same two notes, different body-time: which address do you linger in?", why: "Rhythm transforms not just the melody but the body experience. Holding A for 3 beats means dwelling in chest warmth. Holding E for 3 beats means dwelling in openness. The rhythmic choice is also a body-time choice — which resonance address gets more attention changes the emotional quality (Zamorano 2025)." },
        { text: "Create YOUR phrase: pick a rhythm pattern for A and E that you like — the one that feels best in your body, the body-journey you want to take. Repeat it 4 times. That's a melodic motif — the seed of a song, born from a body preference.", why: "Choosing a pattern you like is the first act of embodied composition. The hear-feel-choose cycle runs in reverse: you chose the body-feeling first, then the rhythm that supports it, then the notes that create it. This is how songs begin." },
        { text: "Sing your phrase on 'la' or 'ooh.' As you repeat it, notice: the body journey becomes familiar — the resonance migration between A and E starts to feel like a signature gesture. Record it. This body-gesture IS your first original melody.", why: "Recording captures the idea AND the body gesture. When you come back to this phrase tomorrow, you'll find it lives in your body as a physical pattern, not just a pitch pattern. Melodic memory is somatic memory (Aarhus 2021: imagery + production = equal learning in one-third the time)." }
      ],
      feel: "This should feel playful, not pressured. You're exploring two notes — there's no wrong answer. Any combination of A and E over Am sounds good. After: what did you notice about which body journey you preferred? That preference IS your emerging compositional voice.",
    ...
    },
    {
      ...
      steps: [
        { text: "Phrase 1: rising — sing A-C-E in any rhythm. Feel the vibration climb: chest (A) → upper chest ache (C) → openness (E). The rising body journey creates a sense of lift, of question, of reaching. One bar. Repeat until the body gesture is memorized.", why: "A rising phrase creates a physical lift — resonance climbing through three body stations. The body gesture (chest → ache → openness) IS the emotional gesture. Nummenmaa 2024 found these body maps are cross-culturally universal." },
        { text: "Phrase 2: falling — sing E-C-A in any rhythm. Feel the resonance pour downward: openness (E) → ache (C) → grounded chest (A). The body settles, resolves, returns home. Memorize this descending gesture.", why: "A falling phrase creates somatic resolution — the vibration settling back to the chest. Rising + falling = a complete body-journey. A complete melodic thought has a complete body arc." },
        { text: "Phrase 3: arch — start low, go high, come back (A-C-E-C or A-E-C-A). Feel the body wave: rise through the stations, crest, descend. The arch mirrors a breath — inhale (rising), peak (full engagement), exhale (settling). Memorize it.", why: "Arch shapes are the most common melodic contour because they mirror the body's most natural cycle — the breath. Your body was already singing arches; now you're making the body-contour conscious (Zamorano 2025)." },
        { text: "Phrase 4: your choice — any combination of A, C, E in any order with any rhythm. Choose by body sensation: which body journey do you want to take? What resonance sequence feels most like YOU? Make it feel like YOUR physical signature.", why: "The fourth phrase is unconstrained creation from the body outward. The hear-feel-choose cycle runs in reverse: choose the body-feeling, hear the notes that match, produce them. This is the first moment of genuinely embodied creative freedom in the curriculum." },
    ...
    },
    {
      ...
      setup: "Guitar. Metronome at 80 BPM.",
      steps: [
        { text: "Strum Am for 4 beats. Before singing, feel where A wants to settle in the body — its chest warmth. Sing a phrase using A-C-E, tracking the resonance climbing. When C arrives, feel the harmonic shift and let your voice follow: C-E-G, the body opening into a warmer, brighter space.", why: "Following chord tones with your voice is how melodies and harmony stay connected. The melody 'outlines' the chords." },
        { text: "Continue: G chord — feel the brightness arrive in the throat as you sing G-B-D. Em chord — the resonance settles darker as you sing E-G-B. One phrase per chord, 4 beats each. Each chord has its own body address and its own emotional room.", why: "Each chord gives you three 'safe' notes. You always have options, and none of them clash." },
        { text: "Loop the progression 4 times. With each pass, let the body lead — reach for the resonance feeling you want and let the chord tone follow. Vary rhythm, direction, or which chord tone you emphasize.", why: "Variation on repetition is the engine of interesting melody. Same chords, evolving vocal line." },
      ...
      feel: "Your melody should feel like it's being guided by the chords — pulled gently from one set of notes to the next. When voice and chords align, there's a physical 'click' of consonance that you feel in your body before your ear confirms it. The hear-feel-choose cycle runs phrase by phrase across the changes: as each chord arrives, you feel its gravity in your chest, hear the chord tones it offers, choose the one that serves the melody, and produce it. Across a full progression cycle, the body traces the emotional arc of the harmony.",
    ...
    },
    {
      ...
      steps: [
        { text: "Play your chord progression with your melody from ss-9-8. Hum it once through — feel the body journey of the melody, the resonance rising and settling with each phrase. Lock in both the pitch contour and the physical gesture.", why: "Reaffirming the melody before adding words ensures the pitch and rhythm are stable. Reconnecting with the body gesture keeps the somatic channel open as you add the new layer of words." },
        { text: "Look around you. Describe what you see in short phrases: 'Morning light on the wall.' Fit each phrase into your melody's rhythm. Notice how certain words feel more resonant in certain body addresses — 'light' might want to live higher, 'wall' lower.", why: "Observation-based lyrics are the easiest to generate. You're describing reality, not inventing stories. Zero creative pressure." },
    ...
    },
    {
      ...
      steps: [
        { text: "Set a 10-minute timer. Pick two chords — Am and C, or G and Em. Start strumming. Let attention rest in the body, not the head. Hum over the chords until a melodic shape emerges from somewhere physical — a resonance your chest reaches for, a note the throat wants to produce. Don't wait for inspiration — just start making sound.", why: "Constraints accelerate creativity. Two chords eliminates harmonic decisions so your brain can focus entirely on melody and words. The timer kills perfectionism." },
        { text: "Once you have a 2-bar melodic phrase (even a rough one), add words. Any words. Describe what's in front of you, narrate your morning, say nonsense syllables that feel right in the body. Keep strumming, keep singing.", why: "Words don't need to be good — they need to exist. Placeholder lyrics often contain accidental brilliance that you'd never find by trying to be clever." },
      ...
      feel: "This should feel slightly uncomfortable — like sprinting instead of jogging. The time pressure is intentional. You're building the muscle of finishing, not the muscle of perfecting. Under time pressure, the hear-feel-choose cycle strips down to its fastest form: your body reaches for a resonance, a note emerges, you keep going. No analysis, no second-guessing. The cycle runs on instinct — and what comes out is more authentically YOU than anything you could plan. The body knows your songs before your mind does.",
    ...
    },
    {
      ...
      feel: "This should feel meditative and visual — like painting with your voice. Each tone has a texture and temperature AND a body-location. Root settles in the chest. The minor 3rd tightens the throat slightly with ache. The 5th floats upward toward the mask. You're choosing colors by feeling where they live in your body, then letting the pitch follow. This is the embodiment cycle powering composition: choose the feeling, feel the body position, hear the note that matches, produce it. Nummenmaa (2024) confirmed these body maps for emotion are universal across cultures.",
    ...
    },
    {
      ...
      steps: [
        { text: "Pick your strongest 2-bar phrase from this level's exercises. Sing it 4 times — notice the body gesture it traces, the resonance stations it visits. Lock in both the pitch DNA and the physical signature. This is your seed.", why: "Starting from your best existing material is more efficient than inventing from scratch. Professional songwriters build entire songs from a single 2-bar motif." },
        { text: "Variation 1 — Shift Up: sing the same phrase starting a 3rd higher. Same rhythm, same contour, higher register — the whole body gesture lifts. Feel the resonance migrate to higher stations. Bars 3-4.", why: "Transposition up creates a sense of development and forward motion. The listener recognizes the shape but feels it moving somewhere new." },
        { text: "Variation 2 — Rhythm Change: sing the original phrase (back to the original pitch) but change the rhythm. If it was even quarter notes, make it syncopated. The body stations are the same, but you dwell in them differently. Bars 5-6.", why: "Rhythmic variation is the subtlest and most powerful tool. The melody is recognizable because the pitches are the same, but it feels fresh because the groove changed." },
        { text: "Variation 3 — Reverse or Invert: sing the phrase backward or flip its direction (rising becomes falling). Feel the body journey reverse — resonance that once climbed now descends. Bars 7-8. Let it be weird.", why: "Retrograde and inversion are classical composition techniques that pop songwriters use instinctively. The weirdness creates contrast, which makes the return to the original more satisfying." },
        { text: "Variation 4 — One Note Changed: sing the original phrase but change exactly one note. Feel how a single new body address alters the entire gesture. Bars 9-10. Then repeat the original unaltered as bars 11-16 — feel the body settle home into its familiar path. Record the full 16 bars.", why: "Changing one note is the minimum edit that creates something new. The return to the unaltered original at the end creates resolution — the melody went on a journey and came home." }
      ],
    ...
    },
    {
      ...
      tracks: [{ name: "Deep Soul Groove 80", src: "/deep-soul-groove-80.mp3" }, { name: "Drums Only — Bossa 75", src: "/drums-bossa-75.mp3" }],
      steps: [
        { text: "Section A: strum Am-C-G-Em at 80 BPM. Sing a melody in your low-to-mid range (E3-B3) — feel the resonance settle into the chest, intimate and warm. Relaxed, conversational delivery, breath shallow. This is your verse.", why: "Verses sit lower and calmer. They're intimate and storytelling. Your porch register lives here." },
        { text: "Section B: same chords, but sing higher (B3-E4) with more energy. Feel the resonance lift from the chest toward the mask — the body opens, breath deepens, vowels widen. This is your chorus.", why: "Choruses lift. Even a small range shift (a 3rd higher) creates contrast. The energy difference IS the structure." },
      ...
      feel: "The shift from A to B should feel like sunrise — a gentle but unmistakable lift. Your body knows when the chorus needs to arrive: there's a physical sensation of building tension in the chest during the second verse — a compression that demands release upward. When you shift to Section B, the whole body opens: breath deepens, resonance lifts, posture straightens. When you return to A after B, the body settles back down — it feels like coming home. The embodiment cycle sustains across the full structure, not just phrase by phrase.",
    ...
    },
    {
      ...
      steps: [
        { text: "Choose a different chord progression and strum pattern from your first sketch. Feel how the new chords change the body landscape — different roots pull the resonance to different addresses. Variety is deliberate.", why: "Creating in a different context proves the skill is transferable. One sketch could be luck. Two sketches is a method." },
        { text: "Apply the same process: hear each phrase forming before singing it, feel where the chord tones want to settle in your body, then produce them. Add simple words. Let this one have its own personality — a different body journey than the first.", why: "Each song should sound different because the chords, tempo, and strum feel different. Let the backing guide the melody." },
        { text: "Create two contrasting sections (A and B). The A/B contrast can be different from your first sketch — maybe this one's contrast is rhythmic rather than range-based. Notice how each section lives in a different body state.", why: "There are many ways to create contrast: range, volume, rhythm, density of words, strum intensity. Exploring different contrast types builds your toolkit." },
...

    {
      ...
      steps: [
        { text: "Choose a backing track and strum E-A-B7. Improvise melodies using E major pentatonic (E-F#-Ab-B-C#) for 2 minutes. Notice how E major's body landscape differs from Am — the resonance sits deeper in the chest for the root, and Ab buzzes forward in places C never reached. Let phrases emerge. When one catches your body, repeat it.", why: "The E major guitar voicings resonate differently — open E and B strings ring, creating a natural shimmer. Your voice will respond to this shimmer with different melodic instincts than Am." },
        { text: "Settle on a verse melody in the lower register (E3-Ab3). Feel the resonance deep in the chest — warm, intimate, grounded. Simple words: 'Walking down the shore' or 'Sun going down again.'", why: "Verse melodies in E major sit in a slightly different vocal register than Am. The key literally places your voice in a new physical position, which changes the emotional quality." },
        { text: "Create a chorus that lifts — higher range (B3-C#4), more open vowels, more energy. Feel the body open as the resonance rises toward the mask. The B7→E resolution is your moment of arrival — the vibration settles home. Place your strongest word on the E chord.", why: "B7→E is the tension→resolution pair in E major. Placing the emotional payoff word on the E chord (resolution) creates natural prosody alignment." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Sing your original melody over the A major chords. Some notes will work perfectly. Others will need to shift — C becomes C#, and you'll feel the body address brighten and move forward. G stays G. Adjust by ear and by body sensation. Record the A major version.", why: "Transposing a melody teaches you which parts of a melody are key-dependent (specific notes) and which are key-independent (contour, rhythm, emotion). Both are valuable knowledge." },
        { text: "Listen to both versions back-to-back: Am original, then A major transposition. Place a hand on your chest during playback — feel how the resonance landscape shifts between the two. The melody contour is the same, but the body addresses and the feeling are different.", why: "This comparison is the clearest demonstration of how key affects emotion. Same song, same structure, different key = different emotional meaning. This is why professional producers choose keys carefully." },
