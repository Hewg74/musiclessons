...
export const level11 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      feel: "The audiated notes should feel like they were ALREADY THERE — you're discovering them, not inventing them. Audiating a third note you haven't heard is pure prediction — your model generates a note that doesn't exist yet, based on everything it's learned about how music moves. When the sing step matches what you heard internally, there's a deep satisfaction, like fitting puzzle pieces. The silence between audiating and singing should feel pregnant with sound, not empty.",
