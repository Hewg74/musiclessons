  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        {
          text: "Set a timer for 2 minutes. Start the backing track. Begin improvising. One rule: you must include the 'color note' of your mode (F# for Dorian, F for Mixolydian) at least once every 4 bars. Otherwise, sing freely.",
          why: "The 4-bar rule prevents pentatonic regression — the tendency to retreat to the five safe notes when your conscious attention wanders. By requiring the color note every 4 bars, you keep the mode active in working memory. Over time, this requirement will become unnecessary as the color note integrates into your natural vocabulary. But for now, it's a necessary guardrail."
        },
        {
      ...
      feel: "Like thinking in a different language. At first, you're translating from pentatonic: 'Where would I normally go? OK, now adjust for the mode.' Eventually, the mode becomes the native tongue and you stop translating. That's fluency.",
    ...
    },
    {
      ...
      steps: [
        ...
        {
          text: "For the final 30 seconds, mix all three vocabularies freely. Some pentatonic phrases (safe). Some diatonic phrases (directional). Some chromatic moments (expressive). Let your ear decide when to go 'outside' and when to come 'home.'",
          why: "This free mixing is the goal state of melodic fluency. A skilled improviser doesn't think 'now I'll sing pentatonic, now I'll go chromatic.' They hear the music and respond with whatever notes serve the moment. Safe moments use safe notes. Intense moments use tension. Climactic moments use chromatic color. By mixing all three vocabularies in real time, you're training the ear-to-voice connection to draw from the FULL palette rather than a restricted set."
        },
        {
