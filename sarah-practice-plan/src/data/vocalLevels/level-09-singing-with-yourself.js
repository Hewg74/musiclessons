...
export const level9 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      recorder: true,
      steps: [
        { text: "Sing A3 — feel it settle deep behind the sternum, warm and grounded. Now sing E4 (a 5th above) — feel the vibration leap upward from chest to throat, opening into spaciousness. The 5th between them creates a physical sensation that neither note alone has: a ringing fullness that fills the whole ribcage. Sustain both notes for 4 seconds each and notice their distinct body addresses.", why: "The 5th is the most consonant interval after the octave. It sounds ancient and strong because the frequency ratio is 3:2. The body registers this consonance as a physical openness — the chest and throat resonate together, creating a sensation of space (Nummenmaa 2024: body maps of resonance are cross-culturally universal)." },
        { text: "Play Am on guitar and sing the root (A3) — feel its chest depth. Then sing the 5th (E4) — feel the vibration climb to the throat. Each root-5th pair creates the same body journey: grounded depth to open height. Try C3→G3, G3→D4. The body-location shift is consistent: root sits in the chest, 5th lifts toward the throat.", why: "Practicing the 5th above each root trains both your ear AND your body map. The 5th always creates the same body-direction shift (chest to higher) regardless of the starting pitch. This somatic consistency makes 5ths easy to find by feel (Zamorano 2025: body awareness predicts pitch accuracy, R²=0.41)." },
        { text: "Sing a simple Am melody. Record it. Play back and try singing a 5th above. Feel how the harmony line sits higher in your body — throat and mask territory — while the recorded melody resonates from your memory in the chest. Two body locations, two voices.", why: "5th harmonies occupy a different body address than the melody. When you sing the 5th while hearing the root-based melody, your body holds two resonance locations simultaneously — the remembered chest-warmth of the melody and the live throat-openness of the harmony." },
        { text: "Compare: play back your melody and sing 3rds, then 5ths. Feel the body difference: 3rds sit closer to the melody's body address (intimate, near), 5ths leap to a more distant address (open, vast). The physical distance between the two voices IS the emotional distance.", why: "3rds are sweet and close — they share body space with the melody. 5ths are open and powerful — they occupy distant body addresses. The somatic distance mirrors the emotional distance: closeness = intimacy, distance = power. Knowing both body-feelings gives you arrangement control (Aarhus 2021)." },
    ...
    },
    {
      ...
      recorder: true,
      steps: [
        { text: "Play a C chord. Sing C3, then E3. That's a major 3rd — 4 half steps. Feel the brightness in your body: the major 3rd sits forward and open, the vibration spreading from the chest toward the face. It carries a warmth that fills the upper body. Hold both notes and feel the resonance expand.", why: "The major 3rd defines a major chord's character. The body registers it as openness and forward placement — the vibration spreads rather than concentrating. Nummenmaa 2024 (PNAS) found that positive emotional states (like the brightness of a major 3rd) activate more upper-body and facial resonance." },
        { text: "Now play Am. Sing A3 and C4. That's a minor 3rd — 3 half steps. Feel how the body shifts: the minor 3rd sits deeper, more compressed, the resonance turning inward rather than spreading. A slight tightening in the throat, an ache that the major 3rd doesn't have. One half step less, but a completely different body landscape.", why: "The minor 3rd is the sound of longing. The body mirrors this: while the major 3rd opens and spreads, the minor 3rd compresses and deepens. This body-level distinction is faster and more reliable than counting half steps (Zamorano 2025: body awareness predicts pitch accuracy, R²=0.41)." },
    ...
    },
    {
      ...
      steps: [
        { text: "Track 1: Record a bass vocal — root notes of the progression in low chest voice. Am = A2, C = C3, G = G2, D = D3. Long, sustained tones. Feel each root settle into its deepest body address: A2 rumbles behind the sternum, C3 warms the lower ribcage, G2 drops into the belly. This is the floor of your arrangement — the lowest body stations you can reach.", why: "The bass layer anchors everything harmonically AND somatically. Low chest voice engages the fullest resonance in the body — the vibration fills the entire torso. This is the body's foundation, and every layer above it will reference these deep addresses. The sternum-buzz of A2 is the physical home that the entire arrangement sits on (Zamorano 2025)." },
        { text: "Track 2: Record your melody over the bass loop. Keep it in your sweet spot, E3 to A3. As you sing, feel how the melody sits ABOVE the bass in your body — the melody lives in the mid-chest to throat zone while the bass rumbles below it. Two body regions, two voices.", why: "Melody over bass creates a two-level body experience. Even listening back, your body remembers the bass's depth and the melody's mid-chest address. The two layers occupy different somatic zones — the bass grounds the chest floor while the melody floats above it." },
        { text: "Track 3: Record a high harmony (3rd or 5th above the melody). This layer lives in the throat-to-mask zone — the highest body address in your arrangement. As you sing it, feel the vibration sitting above both the bass (chest) and melody (mid-chest). Three body stations, three voices, the full vibration-rising map activated simultaneously.", why: "Three-stream auditory processing is the cognitive peak, but the body provides a scaffolding: bass in the chest, melody in the mid-chest, harmony in the throat-to-mask. These three body stations create a physical architecture for the arrangement. When all three are active, the resonance fills your entire body from sternum to forehead — the full vibration-rising map (Nummenmaa 2024)." },
    ...
    },
    {
      ...
      steps: [
        { text: "Record a sustained A2 on Track 1. Hold it for 4 bars, let it loop. Use your deepest, warmest chest voice — feel the vibration settle into the lowest region of your body, behind the sternum, filling the ribcage like a warm tide. This is the lowest body address, the foundation of everything.", why: "The bass pad note is the harmonic AND somatic foundation. A sustained low note engages the full chest resonance — the vibration fills the torso. This is the same body-filling sensation as the Indian tanpura or Australian didgeridoo. The physical warmth IS the harmonic warmth." },
        { text: "On Track 2, record a sustained E3 over the A2 loop. The 5th sits higher in the body — feel it in the upper chest, more open and floating than the root. As both notes ring together, feel the resonance expand: the root grounds the lower chest while the 5th opens the upper chest. Your body is becoming the chord.", why: "Root + 5th creates the body's open architecture — deep warmth below, openness above. The two notes occupy different body stations, creating a physical spaciousness that the listener hears as consonance. When both voices blend, the resonance fills the entire chest cavity (Zamorano 2025)." },
        { text: "On Track 3, record a sustained C3 over the A2 and E3 loop. The minor 3rd sits between root and 5th in the body — mid-chest, with the ache of the minor quality. Root (deep chest) + minor 3rd (mid-chest ache) + 5th (upper chest openness) = an Am chord built from three body stations. Three layers of YOUR resonance, stacked vertically through your torso.", why: "You've just built a chord with three layers of your own body's vibration. Each voice occupies a distinct body address: root in the chest floor, 3rd in the mid-chest, 5th in the upper chest. The vocal pad IS the vibration-rising body map made audible — your body's resonance architecture, sustained and looped (Nummenmaa 2024)." },
