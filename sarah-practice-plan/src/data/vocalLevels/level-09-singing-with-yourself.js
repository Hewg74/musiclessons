...
export const level9 = {
  ...
  description: "Elliott Smith sang 3-part harmonies with himself. Bob Marley's backing vocals were as iconic as his leads. Bon Iver builds entire songs from stacked vocal layers. This level teaches you to harmonize with yourself -- the essential skill for looper-based singer-songwriter performance. Your brain has a dual-stream auditory system: one stream tracks the melody you're hearing, the other tracks the melody you're singing. Training both streams to run simultaneously is the neural foundation for all self-harmony.",
  ...
  exercises: [
    ...
    },
    {
      ...
      feel: "The vocal pad should feel like an environment, not a performance. You're creating a sonic space to inhabit. When you sing a melody over it, you should feel like you're singing inside a cathedral built from your own voice.",
