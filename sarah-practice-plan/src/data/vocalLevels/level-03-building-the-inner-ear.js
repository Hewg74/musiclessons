...
export const level3 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      feel: "Eyes-off practice should feel slightly vulnerable — like singing without a safety net. That vulnerability IS the learning. Removing visual feedback forces your prediction model to generate without external confirmation — every note becomes a pure prediction, tested only by your ears. The discomfort decreases rapidly as your internal hearing strengthens.",
    ...
    },
    {
      ...
      referencePitches: getPitchRange("A2", "E4"),
      pianoKeys: { notes: ["A3", "C4", "E4"], label: "Do-Mi-Sol (Am)", range: ["A3", "E4"] },
      pitchContour: true,
      steps: [
        ...
        { text: "Now Mi — in Am, that's C. From silence, feel where Mi lives — brighter than Do, forward in the throat/jaw. The minor 3rd has that aching quality. Sing. Check. 3 rounds.", why: "Mi is defined by its relationship to Do — generating it from silence requires internalizing the minor 3rd interval, not just an absolute pitch. If it's difficult, try hearing Do first (silently), then feeling the relationship upward to Mi." },
