  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "While still imagining it, notice WHERE in your body you feel the echo of the note — chest, throat, behind the nose. Then sing on 'lah'. Wait until the mental image feels solid. Check Pitch Detector.", why: "The gap between hearing and singing is where your brain maps imagined pitch to vocal fold tension and airflow. You're executing a prediction, not parroting. The body-scan step builds interoceptive awareness — Zamorano 2025 showed that professional singers significantly outperform non-singers on body-awareness measures, and this awareness is trainable." },
    ...
    },
    {
      ...
      recorder: true,
      steps: [
        { text: "Sing the full C major scale with solfege. Confirm it's accurate — this is your reference template. On the second pass, close your eyes and notice where each degree resonates in your body: Do in the chest, Sol behind the nose, high Do at the crown.", why: "You need the complete auditory trace before removing parts. The full scale creates the motor-auditory memory you'll draw on during silence. Adding a body-scan layer gives your brain a SECOND representation of each pitch — location, not just frequency — making the silent portions more vivid (Zamorano 2025)." },
