...
export const level6 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      metronome: 70,
      steps: [
        { text: "Play A2 on guitar. Sing it on 'mah'. Feel the vibration settle deep behind the sternum — a warm rumble that fills the ribcage like low tide. This is the root's body address: chest-deep, grounded, the physical sensation of 'home.' Hold 4 beats at 70 BPM.", why: "'Mah' opens the throat. Low frequencies genuinely resonate in the thoracic cavity — the sternum vibrates, the ribs hum. This body address becomes your landmark for the root. Zamorano (2025) found that body awareness predicts pitch accuracy even in non-singers (R²=0.41). The chest-rumble IS how you'll find this note without the guitar." },
        { text: "Step up on 'mah': C3 (still chest but lighter, the vibration lifts to the upper sternum with a minor-third ache), D3 (mid-chest, a bridge station between depth and brightness), E3 (the vibration brightens and pushes forward toward the throat), G3 (the buzz arrives at the mask — behind the nose, in the cheekbones). Hold each 4 beats. Five notes, five body stations, the vibration rising through your torso like warmth climbing.", why: "Each note has a specific body address. Mapping these addresses builds the vibration-rising body map: chest (low) → throat (mid) → mask (high). Nummenmaa 2024 (PNAS, n=1,938) confirmed these resonance body maps are cross-culturally universal. This isn't metaphor — it's how your resonant chambers physically respond to different frequencies." },
        { text: "Descend: G3-E3-D3-C3-A2, each held 4 beats. Feel the vibration pour back down — mask to throat to chest, like warmth settling. The resonance returns to the sternum's deep rumble. Your larynx lowers with the pitch, and the body follows.", why: "Your larynx naturally lowers on descent, changing timbre and body-location. These physical changes are the pentatonic's body vocabulary — five stations you can navigate by feel, not just by ear. The descending body-journey (mask → chest) mirrors the emotional quality of resolution: settling, grounding, coming home." },
    ...
    },
    {
      ...
      pianoKeys: { notes: ["A3", "C4", "D4", "E4", "G4"], label: "Am Pentatonic", range: ["A3", "G4"] },
      steps: [
        { text: "Sing only 2-note phrases: A-C, C-D, E-G. Leave 2+ beats of silence between each. In that silence, AUDIATE the next phrase before singing it — hear it in your mind's ear first.", why: "Two notes are the smallest melodic unit. Silence lets your auditory cortex process and plan. Using that silence to pre-hear the next phrase strengthens the forward model from Level 3 (v3e1). Tinariwen's vocals work this way — short spaced phrases, each a complete thought. Aarhus 2021 found combined imagery + singing = equal learning in 1/3 the time." },
    ...
    },
    {
      ...
      pianoKeys: { notes: ["A3", "C4", "D4", "E4", "G4"], label: "Pentatonic", range: ["A3", "G4"] },
      steps: [
        { text: "Khruangbin Style 80. First 30 seconds: long sustained notes, 2-4 bars each. Before each note, close your eyes and AUDIATE it — hear the specific pitch in your mind's ear for 2 seconds, then sing. Open eyes to check Pitch Detector after.", why: "Long notes reveal how each pentatonic degree interacts with full harmonic texture. The audiate-before-singing protocol builds on Level 3's forward model (v3e1) — pre-hearing activates auditory cortex BEFORE motor cortex (Gordon Stage 6), making pitch more accurate and intention-driven rather than reactive." },
    ...
    {
      id: "v6e13", time: 5, title: "The Shift — From Ears to Bones", type: "vocal",
      drone: { root: "A", octave: 2, texture: "pure" },
      what: "Discover your body's bone-conducted feedback channel — a proprioceptive sense of pitch that exists independently of what you hear through the air. Expert singers rely on this internal channel more than their external hearing. This exercise makes it conscious.",
      setup: "Drone on A. No guitar needed. Quiet room.",
      referencePitches: getPitchRange("A2", "E4"),
      pitchContour: true,
      steps: [
        { text: "Sing A on 'ahh' at comfortable volume. Listen to yourself normally — through the air, the way anyone in the room would hear you. Notice the sound quality: airy, resonant, blending with the room. This is your air-conducted feedback channel — the one you've been using.", why: "Most singers rely exclusively on air-conducted feedback — hearing themselves through the room. This works but it's affected by room acoustics, background noise, and the fact that your ears hear your voice differently than others do." },
        { text: "Now gently cover both ears with your palms (press flat against your ears to seal them). Sing the same A on 'ahh' at the SAME volume. Notice: the sound is dramatically different. It's louder, richer, more resonant — and it's coming from INSIDE your head, not the room. That's bone-conducted vibration: your vocal folds vibrating, the vibration traveling through your skull bones directly to your cochlea. IMPORTANT: you may notice an urge to sing louder with your ears covered — that's the Lombard effect, an involuntary reflex. Consciously keep the same volume. The point is to notice the VIBRATION channel, not to push harder.", why: "Stanford bone conduction research confirms that vocal fold vibrations propagate through skull bones to the cochlea, giving singers a direct somatic sense of pitch independent of air-conducted sound. This bone-conducted channel is what classical training progressively shifts reliance toward. The Lombard effect (involuntary volume increase when you can't hear yourself) is a known reflex — acknowledging it prevents you from accidentally straining." },
        { text: "With ears still covered, sing A → C → E slowly. Notice how each pitch lights up a DIFFERENT part of the skull. A buzzes in the lower skull and jaw. C shifts to the mid-skull and back of the throat. E rings higher — behind the cheekbones, the nasal bridge. The bone-conducted vibration map is the somatic version of the vibration-rising map you've been learning.", why: "Bone conduction follows different pathways for different frequencies — lower pitches transmit through the jaw and lower skull, higher pitches through the facial bones and sinuses. With air-conducted sound blocked, these somatic differences become vivid. This is the physical basis of the chest-throat-mask body map." },
        { text: "Uncover your ears. Sing A → C → E again. Now you have TWO feedback channels: the air-conducted sound (what others hear) and the bone-conducted vibration (what you feel inside). Notice both simultaneously. The air channel gives you room sound; the bone channel gives you body resonance. Both carry pitch information.", why: "Dual-channel awareness is the goal. Professional singers who've trained for ~3 years begin relying more on the bone-conducted/proprioceptive channel than on air-conducted sound (Zamorano 2025). You're making this shift conscious and deliberate rather than leaving it to accumulate over years." },
        { text: "Final test: cover ears, sing a 4-note pentatonic phrase (A-C-D-E). Focus entirely on the bone-conducted feedback. Then uncover ears and sing the same phrase. Does having both channels make you more or less accurate? For most people, dual awareness improves pitch accuracy — you're calibrating two systems against each other.", why: "Comparing single-channel (bone only) to dual-channel (bone + air) singing reveals which channel your voice trusts more. Over time, the bone channel becomes the primary reference — it's always available, unaffected by room acoustics, and directly connected to your laryngeal proprioception." }
      ],
      feel: "Covering your ears should feel revelatory — like discovering a whole dimension of sound you've been ignoring. The bone-conducted vibration is richer, more intimate, more PHYSICAL than air-conducted sound. After this exercise, you'll never un-hear it.",
      wrong: "Don't press too hard on your ears — firm but gentle. If you notice yourself singing louder with ears covered, consciously reduce. The Lombard effect is involuntary; overcoming it is part of the training. If you can't feel differences between notes through bone conduction, try humming instead of singing 'ahh' — humming produces stronger bone vibration.",
      sarah: "Gene, this is going to feel weird. That's the point. The bone channel has always been there — you just haven't been paying attention to it. Classical singers train for years before they shift to relying on this internal feedback. You're doing it consciously in one exercise. After this, every time you sing, you'll notice two things: what you hear through the room and what you feel through your skull. That second channel is your personal tuning fork — and it goes everywhere you go."
    }
  ]
};
