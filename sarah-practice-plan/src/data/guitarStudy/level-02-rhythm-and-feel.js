...
export const level2 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Strum Am at the quietest volume you can manage — your pick barely touching the strings. Feel how light the contact is — the strings barely move under the pick, the guitar body barely vibrates against your chest. Listen for the ghost of the chord. 8 bars.", why: "Quiet strumming requires more control than loud strumming. Your pick hand has to be precise — too light and you miss strings, too heavy and you're back at medium volume. This builds fine motor control in your strumming hand. The near-absence of chest vibration is your body confirming the whisper dynamic." },
        { text: "Now strum Am as loudly as you can while staying relaxed and in time. Full arm motion, hitting all six strings. 8 bars. Feel how your whole body engages — the guitar body buzzes against your chest, your forearm drives the motion from the elbow, the sound fills the room AND your ribcage.", why: "Loud strumming uses your whole arm and shoulder, not just your wrist. If you tense up at high volume, the sound becomes harsh and brittle. Relaxed power = warm volume. The contrast in chest vibration between whisper and shout is your body's volume meter." },
...

    {
      ...
      steps: [
        ...
        { text: "Now strum Am just AFTER the click — a tiny fraction of a second late. The click happens, then your strum follows. Feel how your whole body settles into a more relaxed posture — your shoulders drop, your arm swings lazier, your wrist loosens. The guitar body's vibration against your chest arrives with the same lazy delay, each strum a warm pulse that blooms rather than strikes. Think of it as the click is the wave breaking, and your strum is the foam that follows. 8 bars.", why: "Behind-the-beat feel creates the laid-back, sun-drenched quality you hear in every DOPE LEMON and Khruangbin track. The delay is tiny — maybe 50-80 milliseconds — but the vibe change is enormous. The physical relaxation in your body is not just a metaphor — Zamorano's interoception research shows that body state directly influences musical timing. The chest vibration arriving 'late' becomes a somatic cue for the feel." },
...

    {
      ...
      what: "The Lagoons' 'Close My Eyes' is a dreamy indie track — we believe the chords are D-Bm-G-A at ~104 BPM, but this hasn't been confirmed by a tab source. Hit play above and do your two-listen warmup — absorb first, ghost second. Your motor system rehearses during focused listening. Verify the chords match before learning them. The magic is in the behind-the-beat feel and the ghost strums that make it float.",
...

    {
      ...
      steps: [
        ...
        { text: "Emphasize the blue note: play phrases that linger on Eb — bend into it, slide into it, let it hang against the drone. Feel the dissonance in your body — the guitar's vibration becomes restless against your chest, your fingers sense the string's tension wanting to resolve. Then move to E (up) or D (down) and feel the physical release. The blue note is a tension that demands resolution. Play with the tension. 2 minutes of free exploration.", why: "The blue note is most expressive as a passing tone or a bent note — you don't usually rest on it for long. The body-level dissonance you feel (Zamorano 2025: interoceptive awareness predicts musical sensitivity) is a faster feedback signal than conscious listening. Learning to approach it, linger on it, and resolve it gives you the vocabulary of blues expression." },
        ...
        { text: "Close your eyes. Mute the strings with your palm. Hear a 3-note phrase from the blues scale in your mind — not a random collection, but a phrase with shape: maybe A rising to D then falling to C, or E bending down to Eb and resolving to D. Feel where each note lives on the fretboard — your fingers should know the fret and string before they move. When you can hear the phrase and feel the positions clearly, open your eyes and play it. Did your fingers land where you expected? Playing from audiation — internal hearing leading the hand — makes the scale musical instead of mechanical.", why: "Most guitarists learn scales by running finger patterns across frets — motor memory without audiation. This reversal (hear first, then find on fretboard) builds the neural connection between your inner ear and your fingers. When you eventually improvise, phrases will start in your mind and flow to your fingers, not the other way around. The eyes-closed, strings-muted setup eliminates visual and tactile shortcuts, forcing pure audiation." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Full-step bend: play fret 7 (D), then play fret 9 (E). That's a whole step — twice as far. Now bend from fret 7 to match fret 9. Feel the resistance build through your hand and forearm — the string fights you harder on a full step. Push from your wrist, rotating your forearm, not squeezing with your fingertips. Your whole arm participates. 10 reps with target-note checks.", why: "Whole-step bends are the bread and butter of blues and rock guitar. The target note is further away, so the physical demand is greater. Pushing from the wrist (rotating your forearm) rather than squeezing with your fingertips prevents fatigue and gives more control. Over time, the resistance itself becomes a pitch gauge — you'll feel when the bend has gone far enough." },
        { text: "Bend and release: bend up to the target note, hold it for 2 beats, then slowly release back to the original pitch. Feel the tension plateau at the top of the bend — your hand holding the string against its will. Then feel it surrender as you release, the pitch sliding back down like a sigh. This is the 'cry' of the guitar — one of the most expressive sounds in music. 10 reps.", why: "Bend-and-release is how guitarists create vocal-like phrases. The upward bend is the cry, the release is the sigh. Holding the bend at the top proves you have pitch control — you're not just flicking the string and hoping. The physical sensation of tension-and-release in your hand mirrors the emotional arc the listener hears." },
...

    {
      ...
      steps: [
        ...
        { text: "Add a bluesy embellishment: on the D chord, try a hammer-on from open D string to fret 2. On the Em chord, try a hammer-on from the open A string to fret 2 (A to B, the 5th of Em) — same technique as the D embellishment, different string. These tiny ornaments add personality without changing the song.", why: "Embellishments are the 'accent' in your guitar voice. A hammer-on adds bounce, a bend adds emotion. Used sparingly, they transform a plain strum into something personal and expressive." },
...

    {
      ...
      steps: [
        { text: "Before your first note, establish the intention cycle that will guide every phrase in this exercise. HEAR: pick 2-3 notes from the blues scale internally — which ones? What order? FEEL: sense the fretboard positions — where do your fingers go? SENSE: decide the dynamic shape — does this phrase start quiet and build? One loud accent then silence? A bend that cries? Every phrase should exist fully in your mind before your hands move. Practice this cycle now: eyes closed, hear a phrase, feel the positions, sense the dynamics. Then play. Do this 3 times before moving on.", why: "The hear-feel-sense-play cycle is the difference between improvisation (intentional musical choices) and noodling (fingers wandering across a familiar pattern). By establishing the habit at the start of the exercise, every subsequent phrase carries intention. The 3 practice rounds wire the neural pathway: audiation → motor planning → execution → evaluation. This is how every great improviser operates — they hear before they play." },
        { text: "Before playing, close your eyes over the backing track. Hear a short 3-note phrase in your mind — not on the fretboard, in your EARS. Hum it. Feel where those notes live on the fretboard — your hand knows the distances, the specific frets and strings, the stretch between positions. Then find those notes on the guitar and play them with a dynamic shape. Start each phrase from audiation, not from finger patterns.", why: "Starting from audiation (hearing internally before playing) and adding fretboard spatial awareness (feeling where notes live) ensures your phrases come from musical intention routed through physical knowing. Aarhus 2021 showed that combined imagery + playing produces equal learning in 1/3 the time. The hear-feel-play cycle — audiate the pitch, sense the fretboard location, then execute — is the guitar-specific version of the audiation chain." },
        ...
        { text: "Add bends to your phrases: at least one bend per phrase. Bend into the blue note (Eb), or bend from D to E (whole step). Feel the string resist as you push it — that physical tension IS the musical tension. The bend should be the emotional peak of the phrase — the loudest, most expressive moment. When you release, your hand relaxes and so does the music. 2 minutes.", why: "Bends as dynamic peaks create the classic blues guitar 'cry.' The physical resistance of the string mirrors the emotional tension — your body experiences the dissonance before resolving it. When the bend is the loudest note in the phrase, it becomes the emotional climax — the note the listener leans into." },
        ...
        { text: "Behind-the-beat phrasing: play your phrases slightly behind the backing track's groove. Feel your body settle into a lazy posture — shoulders drop, forearm swings looser, wrist softens. Let the notes land late, especially the bends — the bend starts behind the beat and arrives at the target pitch like it had all the time in the world. Your fingers feel unhurried on the fretboard, taking their time between positions. 2 minutes.", why: "Behind-the-beat phrasing in the blues scale creates the ultimate laid-back guitar sound. The physical relaxation is not cosmetic — it produces different muscle engagement that literally changes your timing and tone. Khruangbin's Mark Speer plays this way constantly — his solos are behind the beat with space between every phrase. That's the target." },
    ...
    // ─── AUDIATION: PENTATONIC CRAWL ───

    {
      id: "gs-2-13",
      time: 10,
      title: "Pentatonic Crawl — Hear Before You Play",
      type: "guitar",
      what: "Slow walk through the Am Pentatonic — but speed is completely irrelevant. Before each note, you must HEAR it internally. The pitch detector confirms whether reality matched intention. One note per 10 seconds is fine. This exercise builds the audiation muscle that turns scale patterns into musical phrases.",
      setup: "Drone on A. Fretboard diagram for reference. Pitch detector on. Metronome OFF — this is about accuracy of internal hearing, not tempo.",
      drone: { root: "A", octave: 2, texture: "analog" },
      fretboard: { scale: "am-pentatonic", position: 1 },
      referencePitches: getPitchRange("A2", "A4"),
      pitchContour: true,
      steps: [
        { text: "Start with the drone on A. Look at the fretboard diagram — position 1, frets 5-8. Place your hand in position but DON'T play yet. Hear the first note (A, 6th string, fret 5) in your mind. Really hear it — not a guess, not 'I know it's A,' but the actual sound of that string ringing at that fret. Feel the pitch in your body. When it's as clear as you can make it internally — only then play it. Check pitch detector. Did reality match?", why: "The delay between intention and execution is the entire exercise. Most guitarists play first and listen second. This reverses the order: hear first, then play, then confirm. The pitch detector provides objective feedback on whether your internal hearing matched reality. Even a few cents of drift is valuable information — it tells your brain exactly where to recalibrate." },
        { text: "Now hear the NEXT note in the scale (C, 6th string, fret 8) internally. Don't move your finger yet. Hear the pitch — it's a minor 3rd above A, that aching interval you know from the triad work. Feel where C lives compared to A — higher, brighter, a step up the body map. When you can hear it clearly, move your finger and play it. Check.", why: "Audiating the next note BEFORE moving your finger means you're playing from your inner ear, not from muscle memory. Muscle memory knows 'next fret in the pattern.' Audiation knows 'the sound of a minor 3rd above where I am.' The second kind of knowledge produces musicians; the first produces pattern-runners." },
        { text: "Continue through all 5 notes of position 1: A → C → D → E → G. For each note: hear it internally → feel the interval from the previous note → play → check. Speed is irrelevant. One note every 10 seconds is fine. If you can't hear the next note clearly, play the current note again and let the interval guide your inner ear to the next pitch.", why: "The 5-note crawl at this pace takes about a minute — and that's perfect. You're building 5 audiation-to-execution connections, not running a scale. Each successful hear-then-play cycle strengthens the neural pathway between your auditory cortex and your motor cortex. This is the foundation of intentional playing." },
        { text: "Now try descending: G → E → D → C → A. Descending intervals feel different from ascending — the pitch drops, the body address descends, the emotional quality shifts. Hear each descending step before you play it. The pitch contour on screen will show whether you're nailing each note or hunting for it.", why: "Descending audiation is harder than ascending for most people — we're wired to hear melodies going up more easily than going down. The pitch contour provides visual evidence of your accuracy: clean steps down = strong audiation; wobbly searching = the ear hasn't fully internalized the interval yet." },
        { text: "Advanced: mute the drone. Hear TWO notes in sequence internally — A then C — before playing either. Hold both pitches and the interval between them in your mind. Then play both. This is the bridge between single-note audiation and hearing phrases. Try other pairs: D-E, G-A (ascending), E-D, C-A (descending).", why: "Multi-note audiation without the drone removes the external pitch anchor. You're now generating and holding pitches purely from internal hearing — the same skill that lets you hear a melody in your head before you play it. If this is too hard today, that's fine — it's a stretch goal that gets easier each session." },
        { text: "Final pass: drone back on. Play the full pentatonic ascending and descending at whatever speed allows you to hear each note before you play it. For some, that's one note per 5 seconds. For others, one note per second. There is no target speed — only target accuracy of internal hearing. The pitch contour will show your story: clean, intentional steps, or searching and correction.", why: "This final pass lets you find YOUR current audiation speed — the fastest tempo at which you can still hear before you play. That speed will increase over sessions as the audiation pathway strengthens. The pitch contour is your progress chart — compare today's with next week's." }
      ],
      feel: "Like reading words in your head before saying them aloud. Each note should feel known before it sounds — the guitar confirms what your inner ear already created. The pace should feel meditative, not rushed. If you're moving faster than your internal hearing, slow down.",
      wrong: "Rushing through the scale by muscle memory — fingers moving before you've heard the note. Playing by pattern ('next fret') instead of by sound ('next pitch'). If you catch yourself moving your hand before hearing the note, stop, mute the strings, and restart the hear-feel-play cycle. Also: don't judge yourself if the pitch detector shows drift. Every correction is your brain recalibrating. That's the training working.",
      sarah: "Gene, this is the exercise that bridges 'knowing where the notes are' and 'hearing the notes before you play them.' Every improviser you love — Mark Speer, Ali Farka Touré, Pedrum Siadatian — hears the phrase before their fingers move. They're not thinking about fret numbers; they're hearing music and their hands follow. This crawl builds that skill one note at a time. It sounds stupidly simple, but it's the single most important thing you can practice for becoming a musical guitarist instead of a pattern-player."
    },

    // ─── COLOR MUSIC: TONE MAP ───

    {
      id: "gs-2-14",
      time: 5,
      title: "Color Tone Map — Know Your Terrain",
      type: "guitar",
      what: "Using the Color Music fretboard, explore each note of the Am pentatonic scale. Tap each note and notice its color. Amber (A) is home. See how your scale notes cluster on one side of the color wheel — that's not random, that's the sound of your key.",
      colorMusic: { root: "A", scale: "minor-pentatonic", mode: "explore" },
      drone: { root: "A", octave: 2, texture: "analog" },
      steps: [
        { text: "Open the Color Music trainer. Turn on the drone. Tap the root note (A) — notice it's amber.", why: "Color gives each pitch a visual identity. Your ear learns to associate the color with the sound." },
        { text: "Tap each pentatonic note in order: A, C, D, E, G. Watch the colors light up on the wheel.", why: "Walking the scale in color order reveals the harmonic neighborhood — these notes live close together on the wheel." },
        { text: "Now tap notes that are NOT in the scale (the ghosted dots). Hear how they clash against the drone.", why: "Tension and resolution become visible — scale notes cluster, non-scale notes are scattered across the opposite side of the wheel." },
        { text: "Toggle between Notes (squares) and Intervals (circles) on the fretboard. Squares tell you WHAT. Circles tell you WHY.", why: "Mike George's ColorMusic system: shapes carry different information. Names = identity, numbers = function." }
      ],
      feel: "Like seeing music for the first time. The colors make invisible harmonic relationships visible. Adjacent colors on the wheel sound harmonically close — this is why some notes 'want' to go to others.",
      sarah: "Gene, this is your map before the journey. Before you can improvise, you need to know the landscape. Color makes the invisible visible."
    }
  ]
};
