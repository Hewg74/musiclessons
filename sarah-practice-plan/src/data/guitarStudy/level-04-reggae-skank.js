  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Dm7: play x-x-0-2-1-1. Notes: D(open D string)-A(2nd fret G string)-C(1st fret B string)-F(1st fret high E). That's D-A-C-F — root, 5th, b7, b3. A complete Dm7.", why: "Dm7 is Am7's natural partner. The two chords share notes (C and E/A) which makes the transition smooth." },
        ...
        { text: "With the barre at the 3rd fret, add your other fingers: ring finger on the 5th fret of the A string, pinky on the 5th fret of the D string. Leave G, B, and E strings barred. This is Gm7: 3-5-3-3-3-3. Notes from low to high: G-D-F-Bb-D-G. That's root-5th-b7-b3-5th-root.", why: "Gm7 is a moveable shape — slide it to any fret and you get a different minor 7th chord. At fret 5 it becomes Am7 (barre version). This one shape unlocks the entire neck." },
