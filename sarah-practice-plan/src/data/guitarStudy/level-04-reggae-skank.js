...
export const level4 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        { text: "Progression 1: Am-D-Am-E. Play 1 bar of each chord, skanking on the offbeat. In A minor, Am is i (home), D major is IV (borrowed from A major — it adds brightness), and E major is V (the dominant, pulling you back to Am). This is the Bob Marley feel — raw, driving, three chords and the truth.", why: "The i-IV-i-V is rawer and more powerful than jazz-influenced progressions. It doesn't resolve smoothly — the IV→i and V→i movements create tension and forward motion rather than harmonic closure. That unresolved quality is what gives roots reggae its driving energy. Reggae guitar is fundamentally a support instrument — it locks with the hi-hat and provides harmonic rhythm, not dominance. Simple, strong chord movement serves that role better than complex harmony." },
