  ...
  exercises: [
    {
      ...
      type: "guitar",
      recorder: true,
      what: "Cycle through blues (Level 1), surf (Level 2), reggae (Level 3), desert (Level 4), Khruangbin space (Level 5), cinematic (Levels 6/8), and soul (Level 7) every 4 bars. Every style you've learned, on demand.",
      tracks: [{ name: "Surf Rock 120 BPM", src: "/surf-rock-120.mp3" }],
      steps: [
        { text: "Start with Surf Rock Beat 120. Bars 1-4: surf tremolo picking (Level 2) — bright Mixolydian, fast picking, forward energy. Bars 5-8: blues bends and pentatonic (Level 1) — dark, behind the beat. Bars 9-12: reggae offbeat skanks (Level 3) — tight chops, offbeat discipline. Keep switching every 4 bars.", why: "Style switching tests whether you've truly internalized each style or just memorized exercises. If you can switch instantly, the style is in your body, not just your head." },
        { text: "Continue the rotation: bars 13-16: desert blues (Level 4) — sus pentatonic, drone, repetition. Bars 17-20: Khruangbin space (Level 5) — sparse, behind the beat, soft attack. Bars 21-24: cinematic (Levels 6/8) — fingerpicked arpeggios, Phrygian drama, dynamics.", why: "Adding more styles to the rotation demands faster mental switching. Each style requires a completely different physical approach — pick attack, hand position, rhythmic feel, scale choice." },
    ...
    },
    {
      ...
      steps: [
        { text: "Record Layer 1 — Rhythm: a chord progression using extended voicings (Level 7) with ghost note rhythm (Level 3/7). Am9→Dm7→G9→Cmaj7, 2 bars each, 1 minute total. Steady tempo. This is your foundation.", why: "The rhythm part is the foundation of any arrangement. Using extended chords with ghost notes gives it sophistication and groove simultaneously." },
        { text: "Record Layer 2 — Lead: over your rhythm track, play a melodic part using A Dorian. Simple phrases, spacious, behind the beat (Level 5 approach). This is your melody voice.", why: "The lead should complement the rhythm, not compete with it. Using the spacious Khruangbin approach ensures the parts breathe together." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Minutes 5-10: transition to jangle territory. Switch to arpeggiated sus2/add9 voicings (Dsus2, Aadd9, Csus2). Let open strings ring. The energy shifts from driving to shimmering. If you can, blend in some blues bends — surf meets psychedelia.", why: "The transition from pure surf to jangle-psych is where styles begin to merge. Don't stop between styles — let one flow into the other through shared elements." },
    ...
    },
    {
      ...
      type: "guitar",
      recorder: true,
      what: "15 minutes flowing from reggae offbeat skanks (Level 3) into Khruangbin space (Level 5) into soul groove with extended chords (Level 7). The rhythm-focused golden hour.",
      ...
      steps: [
        { text: "Minutes 0-5: Reggae One Drop 85. Open with reggae skanks on Am7→Dm7 (Level 3). Tight chops, clean offbeat, deep in the pocket. Add brief lead breaks in the Skinshape style — taste, not feast.", why: "Starting with reggae establishes the groove as king. Everything in this set serves the pocket." },
        { text: "Minutes 5-10: transition to the Khruangbin Style 80. Shift from reggae rhythm to Khruangbin space — softer attack, behind the beat, sparse pentatonic phrases with global flavors (Level 5). The energy gets more introspective.", why: "The transition from reggae drive to Khruangbin float should feel like the sun setting — the energy doesn't drop, it transforms from external to internal." },
