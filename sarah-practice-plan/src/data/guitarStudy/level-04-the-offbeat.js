  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Free reggae improv: 5 minutes over either track. Use everything — ghost notes, mute speed variation, dynamic swells, one-drop accents, silence. Stay on Am the entire time. Before each textural shift, hear the new texture in your mind first — imagine the ghost notes before you play them, hear the swell building before your hand moves. Let your inner ear direct the arrangement.", why: "Extended single-chord improv is the ultimate test of rhythmic creativity. Pre-hearing each textural shift activates auditory cortex before motor cortex (Gordon Stage 6), turning reactive noodling into intentional arrangement. If you can make 5 minutes of Am skank interesting through dynamics, muting, and ghost notes — all directed by your inner ear — you've internalized the reggae guitarist's toolkit." }
      ],
