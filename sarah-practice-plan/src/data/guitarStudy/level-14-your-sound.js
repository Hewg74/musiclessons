...
export const level14 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      wrong: "If you're too nervous to start, remember: this recording is for you. Nobody else has to hear it. If the set falls apart midway through, finish it anyway — the act of completing it matters more than perfection. End on something you love — your brain encodes the final sound as the summary of the whole experience. If it feels anticlimactic, listen back tomorrow with fresh ears. It will sound better than you think.",
