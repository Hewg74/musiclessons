  ...
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "After a minute, add melody notes with i and m. But audiate each one first: hear the note in your mind, feel it in your throat (silent singing), then pluck it. Keep it sparse — 2-3 melody notes per bar, placed between the thumb's bass notes. Let the melody breathe. Think Tommy Guerrero: melody-as-vocalist, every note heard before it's played.", why: "Sparse melody over simple bass is the sweet spot for early duo improvisation. Adding the audiation step (hear → feel → play) ensures each melody note IS intentional — chosen by your inner ear, not grabbed by your fingers. Aarhus 2021 showed this imagine-then-execute approach equals full learning in 1/3 the time. The temptation is to play too many notes. Audiation naturally limits output, because you can only play what you've pre-heard." },
