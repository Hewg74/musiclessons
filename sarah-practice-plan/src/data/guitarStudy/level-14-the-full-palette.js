...
export const level14 = {
  ...
  exercises: [
...

    {
      ...
      type: "guitar",
      what: "Play Am-G-C-D in SIX completely different styles: surf strum, reggae skank, fingerpicked, power chords with palm mute, desert drone, and top-string triads. The chords never change — YOUR approach does. This is the core integration exercise: same harmonic content, six emotional universes.",
      ...
      steps: [
        { text: "Surf strum: Am-G-C-D with constant arm motion, bright down-up pattern, let open strings ring. Feel the continuous arm flow — smooth, unbroken, your forearm swinging like a pendulum. The guitar body vibrates with a sustained shimmer against your chest, open strings sustaining through chord changes. Think Allah-Las — reverb-drenched, jangly, every chord bleeds into the next. Play 8 bars at 120 BPM.", why: "Surf strum is your first color. The constant arm motion and ringing open strings create that shimmering, beach-at-golden-hour quality. The physical signature is continuous forearm flow — never stopping, never pausing. This is the style you learned in Level 1 — it should feel effortless now." },
        { text: "Reggae skank: same Am-G-C-D, but now strum ONLY on the 'ands' — upbeats only, immediate palm mute after each chop. Feel the transformation in your body: the continuous forearm flow of surf becomes a wrist snap. The palm clamps the strings dead after each chop — chest vibration becomes staccato bursts instead of sustained shimmer. Short, percussive, bouncy. Drop the tempo to 85 BPM. Think Gimme Love.", why: "The skank transforms the same chords from shimmering surf into bouncy reggae. The physical shift is dramatic — different muscles (wrist vs forearm), different resonance pattern (bursts vs sustained), different body posture (leaning back vs forward). Nothing changed harmonically — the BODY changed everything." },
        ...
        { text: "Desert drone: keep the low A string droning open while you play fragments of G, C, D on the upper strings. Feel the drone vibrating continuously through the guitar body into your chest — a physical foundation that never moves. Your melody notes float above it: consonant notes (D, E) relax your body, dissonant notes (Bb, F) create a tension you feel in your sternum before you name it in your mind. Drop to 70 BPM. Sparse. Hypnotic. Quarter-tone bends on the melody notes — feel the string resist under your fingertip as the pitch rises, your body's pitch gauge. Think Tinariwen in the Sahara.", why: "The drone approach dissolves chord boundaries — everything floats over that constant A. The continuous chest vibration from the drone is your somatic anchor, and the body's response to consonance vs dissonance becomes a real-time feedback signal. This is the most meditative style, the furthest from the surf strum. Same four chords, completely different universe." },
        { text: "Top-string triads: play the same Am-G-C-D as voice-led triads on strings 1-2-3 only, Khruangbin-style. Strum lightly on beats 2 and 4. Then try it on strings 2-3-4 for a warmer register. Then mix: verse on mid strings, chorus on top strings. This is the Level 6 triad vocabulary deployed as a sixth stylistic option.", why: "Triads are the sixth color in your palette — lighter than full chords, more harmonic than power chords, more chordal than fingerpicking. In a band context, triads cut through without creating mud. This is how professional session guitarists approach an arrangement: full chords, power chords, OR triads, depending on what the song needs." }
      ],
      ...
      wrong: "If all five styles sound similar, you're not committing to the transformation. The reggae should be NOTHING like the surf — different tempo, different attack, different feel. If you're blending styles, isolate each one and exaggerate its defining characteristic before trying to switch. This mixing of old and new skills in one session is contextual interference — it feels harder than drilling one style, but it builds deeper, more flexible skill.",
...

    {
      ...
      feel: "This should feel like meditation — stillness punctuated by moments of vivid intention. The silence between notes is full, not empty. When you improvise with the 'hear it first' constraint, you're forcing your prediction engine to generate fresh predictions instead of running on cached finger patterns. That's why it feels slower — you're doing real-time model generation, not playback. When a note arises from audiation, playing it feels inevitable — like the only possible next note. If you feel frustrated by the slowness, that's the old motor-first habit protesting. Let it protest. The auditory system is learning to lead.",
      wrong: "If you're playing at normal speed with lots of notes, you've abandoned the constraint — your prediction model is running on cached patterns instead of generating fresh predictions. Stop and restart with the 30-second listen. If you can't audiate at all (no notes arise internally), play a note on the guitar, remove it, hold its memory for 5 seconds, then audiate the next note from that starting point — use the memory of a real note as a springboard. If every note you audiate is the same (just A over and over), challenge yourself to hear a different interval — a 3rd above, a 5th, something unexpected. The constraint doesn't limit WHICH notes you hear; it only requires that you HEAR them first.",
