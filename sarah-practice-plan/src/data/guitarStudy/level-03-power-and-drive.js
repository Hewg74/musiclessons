...
export const level3 = {
  ...
  exercises: [
...

    {
      ...
      what: "The Growlers' Going Gets Tough runs at about 158 BPM (felt in half-time at ~79 BPM) with a bass-strum alternation feel that gives it a half-time heaviness. Capo 1, shapes are G-C-D-Em, plus a signature Cadd6 embellishment that IS the sound of this song. Listen and ghost the changes before playing. This song teaches you alternating bass-strum technique, chord embellishments, and the difference between staccato verses and legato choruses.",
...

    {
      ...
      wrong: "If the jam feels like a random collection of exercises strung together, you're switching techniques too often. Stay in each zone for at least 8 bars before transitioning. If it feels stuck in one gear, push yourself to try the opposite energy — if you've been chugging, go gentle. If you've been gentle, attack. End the jam on something you played well — a clean riff, a solid groove. The final moment is what your body carries into sleep.",
...

    {
      ...
      feel: "This should feel like a diagnostic — honest, clinical, revealing. It's not about sounding good. It's about finding out exactly where your ear-to-hand chain needs work. The information IS the exercise. Treat failures as data, not as mistakes. The three-failure-point diagnostic is really a prediction-error locator: when you audiate C and sing B instead, the prediction error is in the audiation-to-voice link. When you sing C but find the wrong fret, the error is in the voice-to-fretboard link. Each error type tells your brain WHERE to update its model.",
