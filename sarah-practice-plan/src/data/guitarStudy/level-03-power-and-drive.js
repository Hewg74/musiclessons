...
export const level3 = {
  ...
  exercises: [
...

    {
      ...
      type: "guitar",
      what: "The Growlers' Going Gets Tough runs at about 118 BPM with a boom-chuck feel that gives it a half-time heaviness. Capo 1, shapes are G-C-D-Em, plus a signature Cadd6 embellishment that IS the sound of this song. This song teaches you bass-strum alternation, chord embellishments, and the difference between staccato verses and legato choruses.",
      ...
      steps: [
        ...
        { text: "The Boom-Chuck: Going Gets Tough uses a bass-strum alternation. Play the LOW root note of each chord on the downbeat (low E string 3rd fret for G, A string 3rd fret for C), then a quick, snappy strum of the upper strings on the upbeat. Down on the bass, up on the treble. This creates a bouncy, alternating feel that drives the song forward.", why: "The boom-chuck pattern is the rhythmic engine of Going Gets Tough. The bass note anchors the groove while the upper strum provides the energy. This is the same technique used in country, folk, and early rock — it separates the bass and treble roles of the guitar, and you can hear prominent alternating bass lines on the low E and A strings throughout the recording." },
