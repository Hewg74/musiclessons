  ...
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "Eyes still closed. Now sing or hum the note you're imagining — the C. Don't play the guitar yet. Just sing it. Is the pitch steady? Does it match what you heard internally? Open your eyes briefly and check the pitch detector. Were you close? If you were off, the gap between audiation and voice is your current bottleneck.", why: "The audiation-to-voice link is the most revealing diagnostic in music. If you heard C internally but sang B, your voice calibration needs work. If you couldn't produce any specific pitch, your inner hearing may not be vivid enough yet. Both are trainable — Zamorano 2025 shows interoception (including pitch awareness) improves with deliberate practice." },
