  ...
  exercises: [
    {
      ...
      steps: [
        { text: "Play A natural minor: A-B-C-D-E-F-G. Then A Dorian: A-B-C-D-E-F#-G. The only difference is F# instead of F. Play them back to back at 60 BPM, ascending and descending.", why: "Dorian is THE soul scale — the raised 6th (F#) is what separates it from natural minor. Music theorists call it the 'bright minor mode' because the F# adds warmth without losing the minor identity. It makes minor feel hopeful instead of sad, warm instead of cold. Every classic soul guitarist from Curtis Mayfield to D'Angelo's band lives in Dorian. One note changes the entire emotional landscape." },
    ...
    },
    {
      ...
      steps: [
        { text: "Play G9: 3x320x. That's low E 3rd fret (G), skip A, D string 3rd fret (F), G string 2nd fret (A), open B (B), skip high E. The notes: G-F-A-B = root, b7, 9th, 3rd. The 5th (D) is omitted — that's normal for extended chords. Strum it with a sharp, percussive attack.", why: "Dominant 9th chords combine the drive of a dominant 7th with the color of the 9th — the definition of extended harmony adding sophistication without complexity. They're punchy enough for rhythm playing but complex enough for soul harmony. This is 'the' funk chord — James Brown's 'Sex Machine,' Prince's 'Kiss,' D'Angelo's entire catalog all live on dominant 9ths. The 5th is omitted because the root, 3rd, b7, and 9th carry all the harmonic information." },
    ...
    },
    {
      ...
      tracks: [{ name: "Soul Funk Groove 90 BPM", src: "/soul-funk-groove-90.mp3" }],
      steps: [
        { text: "Put on the Soul Funk Groove 90. Play Am9 with a ghost note pattern: muted scratch on beats 1 and 3, chord stab on the 'and' of 2 and 4. This is your reggae offbeat rhythm (Level 4) applied to extended chords.", why: "Ghost notes meet jazz voicings — this is where rhythmic and harmonic sophistication fuse into one technique. Extended harmony adds sophistication without complexity: the 9th and 11th color the chord while the ghost scratches keep the groove percussive and locked. The muted scratches provide rhythm while the extended stabs provide harmonic color. This fusion is what makes Skinshape and BALTHVS sound effortlessly cool." },
    ...
    },
    {
      ...
      levelUp: "Play a 5-minute BALTHVS/Skinshape-style groove: extended chord progression with ghost note rhythm, behind-the-beat feel, and short Dorian fills between changes featuring the F# as color note. Switch between 80 and 90 BPM tracks. Recording sounds like a professional soul-funk session."
    },
    {
      id: "gs-8-10",
      time: 15,
