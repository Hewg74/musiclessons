...
export const level12 = {
  ...
  unlocks: "Fingerpicking (Level 13)",
  review: {
    label: "Level 11 Check-In",
    time: 5,
    exercises: ["gs-11-4", "gs-11-9"],
    prompt: "Play the Skinshape soul cycle Gm-C-A7-Dm with 7th chord voicings (gs-11-4). Then play Khruangbin three-note voicings on the top 3 strings (gs-11-9). Extended harmony is solid? Time to go global."
  },
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "Simplify to the essence: pick just TWO notes (E on the D string, 2nd fret, and G on the G string, open). Alternate between them in a repeating 2-beat pattern. Loop it. Let it become automatic — the pattern should play itself after 2 minutes.", why: "Afrobeat ostinatos are deliberately simple because they need to be PERFECTLY consistent. The magic comes from how multiple simple parts interlock, not from complexity in any single part. If your part is hard to play, it's too complex." },
      ...
      wrong: "If you're adding fills, embellishments, or variations, you're fighting the form. Afrobeat guitar Part A is intentionally repetitive — the urge to embellish is your creative brain resisting a new discipline. That resistance IS the exercise. If the pattern keeps shifting or drifting, slow to 80 BPM and play for 5 minutes — the drift usually stops after 2 minutes when your muscles lock in.",
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Listen back to the full 5-minute recording. Ask yourself: does it have a beginning, middle, and end? Could a listener follow the journey? Is there at least one moment of genuine musical beauty? If yes to all three, you've graduated Level 12.", why: "Self-assessment against clear criteria builds musical judgment. 'Beginning, middle, end' is the simplest compositional framework. 'Followable journey' ensures coherence. 'One moment of beauty' ensures artistry. These three criteria separate noodling from music." }
      ],
