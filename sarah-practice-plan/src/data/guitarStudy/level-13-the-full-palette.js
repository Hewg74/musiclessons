  ...
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "Final round — the 'blind test.' Put on any backing track. Close your eyes. Play the first scale that your ear suggests. Don't think about names — just reach for the notes that FEEL right. After 2 minutes, identify which scale you were playing. Your ear is smarter than your theory.", why: "The ultimate goal is intuitive scale choice — your ear selects the color before your brain names it. When you can do this, you're improvising like a musician, not a student. The theory is a post-hoc explanation of what your ear already knew." }
      ],
...

    {
      ...
      steps: [
        ...
        { text: "For the final 2 minutes, let the improvisation find its natural ending. Don't just stop — deconstruct. Whatever style you're in, simplify: fewer notes, more space, slower, quieter. Let the piece dissolve to silence. Record the whole 10 minutes.", why: "A considered ending transforms a jam into a statement. Deconstruction as an ending technique (from PReVaDe) gives your improvisation an arc — beginning, middle, end. Listen back to hear your palette in action." }
      ],
...

    {
      ...
      type: "guitar",
      what: "Take a single song — Texas Sun (Am-G-Em-D-Bm) — and toggle its feel across three axes: major vs minor voicing, behind-beat vs on-beat placement, clean vs dirty tone. Each toggle changes the mood dramatically. Same song, eight possible combinations. This is the expressive toolkit at full power.",
      setup: "Guitar. Metronome at 100 BPM. Gain/distortion available if you have it.",
      steps: [
        { text: "Play Texas Sun (Am-G-Em-D-Bm) straight — on the beat, clean tone, minor voicings as written. This is the baseline. Play through 4 times. Feel the song's natural melancholy groove.", why: "The baseline establishes your reference point. You need to know what the song sounds like 'normally' before you can appreciate what each toggle does to it." },
...

    {
      ...
      steps: [
        ...
        { text: "For the first 5 minutes, play freely in 1-2 styles. Don't rush to show everything you know. Settle into a groove and let it develop. Depth in one style is more musical than surface-level touches of five styles.", why: "The temptation in a 15-minute jam is to showcase everything immediately. Resist. Great improvisers spend 5 minutes going deep before they shift. Depth creates the foundation for meaningful transitions." },
        ...
        { text: "Between minutes 10 and 15, find your way toward resolution. Maybe the piece intensifies before dissolving. Maybe it gets quieter and simpler. Maybe you discover a new combination that surprises you and you ride it until the end. Let the jam have an ending, not a stop.", why: "A considered ending transforms 15 minutes of playing into a musical statement. Even improvisations have arcs — beginning, exploration, resolution. Finding the ending is an act of musical judgment." },
