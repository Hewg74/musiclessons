...
export const level7 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      wrong: "If the piece feels mechanical or like a checklist of techniques, you're over-thinking. Close your eyes, feel the groove, and let the sections flow into each other naturally. If a section isn't working, cut it — a simple 2-section song played with conviction beats a complex 5-section song played nervously. End on something you're proud of — even if the take wasn't perfect, find a clean ending. Your brain encodes the last moment.",
