...
export const level13 = {
  ...
  unlocks: "Dynamics & Expression (Level 14)",
  review: {
    label: "Level 12 Check-In",
    time: 5,
    exercises: ["gs-12-3", "gs-12-9"],
    prompt: "Play an Afrobeat-style interlocking guitar pattern (gs-12-3). Then play a Tommy Guerrero-style finger-picked melody (gs-12-9). Global colors are flowing? Time to formalize fingerpicking."
  },
  exercises: [
...

    {
      ...
      steps: [
        { text: "Fret Am. Play the pattern note by note at 50 BPM: P (string 5) - i (string 3) - m (string 2) - a (string 1) - m (string 2) - i (string 3). That's one cycle — six notes. Feel the physical journey: thumb plucks the heavy bass string (weight, depth), then each finger steps across progressively thinner strings — the tension lightening under each fingertip as you ascend. At the top (a on string 1, the thinnest), the string barely resists. Then the descent: m and i return through increasingly heavier strings. The fingers go up (i-m-a) then back down (m-i), creating a rolling wave. Play 4 cycles, one note per click.", why: "At 50 BPM with one note per click, you have time to feel the physical gradient from bass to treble. Each finger's string has a different resistance, a different thickness under the pad. This tactile gradient — heavy to light to heavy — IS the wave of the roll, felt in your fingertips before you hear it in your ears." },
...

    {
      ...
      recorder: true,
      what: "Jack Johnson's Breakdown is fingerpicking at its most inviting — four chords (G-Bm-Em-D) with a capo on fret 5, Travis-style picking at a moderate 112 BPM. This song is the perfect bridge between the six-note roll you've been practicing and Travis picking (coming next). The capo moves everything up to the key of C but you play comfortable open shapes.",
      ...
      steps: [
        ...
        { text: "Play along with the original recording (or find it on YouTube). Jack plays at roughly 112 BPM. If 112 feels rushed, stay at 65 and gradually increase. Match his feel: lazy, behind the beat, like a hammock swaying. Nothing in this song is in a hurry.", why: "Playing along with the record trains your ear to match feel, not just notes. Johnson's genius is in the laziness — every note arrives slightly late, slightly relaxed. The notes are simple; the feel is everything." },
      ...
      metronome: 65,
      levelUp: "Play the full Breakdown progression (G-Bm-Em-D, capo 5) with continuous fingerpicking at 100+ BPM for 3 minutes without breaking the pattern. The bass notes land on the correct strings for each chord."
    },
...

    {
      ...
      steps: [
        { text: "Step 1: Thumb only. Fret a C chord. Your thumb alternates between string 5 (the C bass note) and string 4 (the E — the 3rd of the chord). Feel the difference: string 5 is thicker, heavier under your thumb pad — it thumps low through the guitar body. String 4 is thinner, lighter — it rings brighter, less chest vibration. Your thumb learns these two strings by FEEL, not by sight: heavy-light, heavy-light, boom-chuck. Alternate: P on 5, P on 4, P on 5, P on 4. One pluck per metronome click at 40 BPM. This alternating bass IS Travis picking — everything else is decoration on top of this.", why: "The alternating thumb is the engine of Travis picking. The physical contrast between thick and thin bass strings gives your thumb proprioceptive feedback — you know which string you're on by the resistance under your thumb pad, not by looking. If the thumb isn't rock-solid and automatic, nothing else will work. You must be able to alternate bass strings without thinking — the way a drummer's kick drum operates independently from the snare." },
...

    {
      ...
      steps: [
        ...
        { text: "Now alternate: fingerpick a note (P on string 5), then slap. Pick, slap, pick, slap. Feel the two physical signatures: the pick is a precise fingertip pull with focused string vibration buzzing through the guitar body. The slap is a whole-hand percussive hit that briefly deadens ALL vibration — a rhythmic silence punched into the resonance. Your body alternates between vibrating and still, vibrating and still. This is the galloping engine of Hermanos Gutiérrez.", why: "The pick-slap alternation creates the 'gallop' — a rhythmic pattern that sounds like a horse trotting. The physical contrast between focused vibration (pick) and sudden stillness (slap) is the somatic engine of the gallop — your body experiences the rhythm as alternating states of resonance and silence." },
...

    {
      ...
      songRef: {
        ...
        src: "/coastline.mp3",
        note: "Folk fingerpicking with wide-open ocean sound. CGDGGD alternate tuning, capo 2nd fret."
      },
      chordVoicings: { chords: ["G", "Bm", "A", "D"] },
      tracks: [{ name: "A Major Folk 80", src: "/a-major-folk-80.mp3" }],
      recorder: true,
      what: "Hollow Coves' Coastline is gentle fingerpicking at its most beautiful — the original uses an alternate tuning (CGDGGD, capo 2), but the same emotional quality lives in standard tuning with G-Bm-A shapes. This exercise captures the FEEL of Coastline: airy, spacious, each note ringing into the next. Where Breakdown was lazy-warm, Coastline is open-sky luminous.",
...

    {
      ...
      steps: [
        { text: "Start the backing track. For the first minute, just play bass notes with your thumb — one per bar, matching the chord roots. Your thumb carries the bass — feel its weight on the string, the thick vibration that travels through the guitar body into your chest. Your thumb is a bass player warming up, finding the groove, settling in.", why: "Starting with bass only lets you lock into the track's groove before adding melodic complexity. The physical weight of the thumb on bass strings — thicker, heavier, deeper vibration — is qualitatively different from what the fingers do. That weight IS the bass voice." },
        { text: "After a minute, add melody notes with i and m. Your fingers carry the melody — feel their lightness on the treble strings, the delicate pluck that sends a bright vibration shimmering above the bass. But audiate each melody note first: hear it in your mind, feel where it lives on the string, then pluck it. Keep it sparse — 2-3 melody notes per bar, placed between the thumb's bass notes. Let the melody breathe.", why: "The physical contrast — thumb weight on bass, finger lightness on melody — is the embodied version of the duo concept. Each finger has its own relationship to the string. Adding the audiation step (hear → feel → play) ensures each melody note IS intentional. Aarhus 2021 showed this imagine-then-execute approach equals full learning in 1/3 the time." },
...

    {
      ...
      recorder: true,
      what: "Your Level 13 graduation piece. Combine everything: six-note roll, Travis picking, percussive slap, duo thinking, pick tuck, dynamic shaping. Play a 4-minute fingerpicked piece that has a clear structure — intro, verse, chorus, bridge, outro. Use chord changes from Breakdown (G-Bm-Em-D) or create your own. This is not an exercise. This is a performance.",
