...
export const level12 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Name your five levels out loud: 1 = ppp (ghost strum, pick barely touching), 2 = pp (soft, intimate, fingertips only), 3 = mf (medium, conversational, your default), 4 = f (strong, projecting, audience of 50), 5 = fff (full power, every string ringing, audience of 500). Strum Am at level 1 for 4 bars. Really commit — this should be barely audible.", why: "Naming the levels makes them concrete. Most guitarists live at levels 3-4 and never visit 1-2 or 5. By giving each level a physical description, you create targets to aim for. The quietest level is the hardest — it requires the most control." },
...

    {
      ...
      steps: [
        ...
        { text: "Volume at 0. Strike Am hard — you should hear nothing (or just the acoustic ghost of the strings). Now slowly roll the volume up over 3-4 seconds. The chord blooms from silence into full, with no pick attack. Hold the swell at full volume, then let it ring out. 4 repetitions.", why: "The pick attack is what makes a guitar sound like a guitar. Removing it by swelling in from zero creates a completely different instrument — warm, bowed, orchestral. This is the same technique pedal steel players use, but done manually." },
        ...
        { text: "Swell with the metronome: set a slow tempo (60 BPM). Strike on beat 1 at volume 0, reach full volume by beat 3, hold through beat 4, roll back to 0 during the next bar's beats 1-2, strike a new chord on beat 3. Each swell takes 2 bars. Play through Am-D-G-Em, 2 bars each. Record it.", why: "Metronomic swells prove your timing is controlled, not random. When swells align with a tempo grid, they can be used inside real songs — building verses, creating tension before a chorus, or closing out a final chord." }
      ],
      ...
      volumeMeter: true,
      volumeContour: true,
      levelUp: "Can chain 4 smooth volume swells (Am-D-G-Em) with no audible pick attack, each blooming and fading in sync with a 60 BPM metronome, recorded and verified."
    },
...

    {
      ...
      type: "guitar",
      what: "Current Swell's 'Marsha' is a 6-chord song (F-G-Bb-C-D-Dm) at 116 BPM with a distinctive intro riff and the D→Dm magic moment. The song starts intimate and builds to full band power — a complete dynamic arc in 4 minutes. You'll learn the chords, the intro riff, and most importantly, the dynamic shape that makes this song breathe.",
...

    {
      ...
      steps: [
        ...
        { text: "Now add Bb — one fret above A, at fret 6 on the low E string. Play: A-Bb-A. Just touch the Bb and come right back to A. Hear the tension? That half-step creates friction, darkness, a Spanish flavor. Try it higher: E(12th fret)-F(13th fret)-E. Same half-step, same color. 8 repetitions at each position.", why: "The Phrygian b2 (Bb in A Phrygian) is the most distinctive interval in the mode. Just touching it and resolving back to the root creates instant Spanish/North African flavor without learning a whole new scale. It's a color — dip your brush in it and come back to familiar territory." },
        ...
        { text: "Listen to Tinariwen and Hermanos Gutiérrez while paying attention to the half-step tensions in their melodies. Those dark, Spanish-sounding moments? Often a Phrygian b2. Now improvise for 2 minutes: Am pentatonic with occasional Bb touches, over the drone. Channel the desert. Record it.", why: "Connecting the theoretical concept to music you already love makes it stick. When you hear the Phrygian b2 in Tinariwen, you'll feel ownership over the sound — it's not an abstract scale, it's a color you recognize and can now produce yourself." }
      ],
...

    {
      ...
      steps: [
        ...
        { text: "VARY: play the same motif, same notes, same rhythm — but now at level 5 (full power). The volume jump should feel dramatic, like a camera cutting from a close-up to a wide shot. 4 repetitions at full volume. Same notes, completely different emotional impact.", why: "Dynamic variation proves that volume IS content. The same melody at whisper volume and full volume tells two different stories. The listener hears the same notes but FEELS something entirely different. This is the core insight: dynamics are not decoration — they're meaning." },
...

    {
      ...
      steps: [
        { text: "Start by playing single notes — just A and E — over the backing track at level 1 (whispered). Hold each note for 2-4 beats. Leave enormous space. The track is doing the heavy lifting. You're adding color, not content. 2 minutes.", why: "Starting quiet forces you to LISTEN to the track rather than dominate it. At whisper volume, you're painting light brushstrokes on top of the groove. This is how Mark Speer starts every Khruangbin performance — below the track, not above it." },
        ...
        { text: "Build: over the next 2 minutes, gradually let your dynamic range expand. More loud moments. Longer loud passages. But always return to quiet. The quiet sections are the foundation — the loud moments are the peaks. The ratio should be about 70% quiet, 30% loud.", why: "The 70/30 ratio keeps the loud moments meaningful. If you're loud 50% of the time, nothing feels dramatic. If you're loud 20% of the time, the peaks are rare but stunning. Find the balance where each loud passage feels earned." },
