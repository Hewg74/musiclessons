...
export const level12 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Start by playing single notes — just A and E — over the backing track at level 1 (whispered). But hear each note before you play it: close your eyes, audiate the pitch AND the volume level together, then execute. Hold each note for 2-4 beats. Leave enormous space. The track is doing the heavy lifting. You're adding color, not content. 2 minutes.", why: "Starting quiet forces you to LISTEN to the track rather than dominate it. Audiating both pitch and dynamics together (not just 'what note' but 'how loud') trains integrated inner hearing — the full Audiate-Play-Transfer protocol. At whisper volume, you're painting light brushstrokes on top of the groove. Mark Speer starts every Khruangbin performance this way — below the track, not above it, with every note pre-heard." },
