...
export const level12 = {
  ...
  exercises: [
...

    {
      ...
      wrong: "If the piece feels like a grab bag of techniques strung together, your transitions aren't smooth enough. Each section should LEAD to the next — the end of the volume swell naturally opens into the D→Dm meditation, which naturally leads to the PReVaDe section. If everything is at the same volume, you haven't committed to the quiet sections. If the recording sounds like a practice session rather than a performance, try one more take with full commitment. Before you record: what story are the dynamics telling? After: did the arc surprise you anywhere? End on something beautiful — the last sound your brain encodes is the sound it keeps.",
