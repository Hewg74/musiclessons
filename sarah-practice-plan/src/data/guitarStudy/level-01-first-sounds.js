...
export const level1 = {
  ...
  exercises: [
...

    {
      ...
      feel: "This should feel like a competitive game against yourself — you're trying to beat your own high score. The excitement of watching your count climb over days is genuinely addictive. When a pair hits 30+ changes per minute, the transition feels invisible. Don't finish one exercise completely before starting the next. Practice in rotating sets of 3-5 exercises — play through exercises 1, 2, and 3 for one round, then cycle back. This 'interleaved practice' feels harder in the moment but builds stronger long-term retention than grinding one exercise until it's perfect. End each session on a pair you nailed — your brain encodes the last thing you played, so finish with confidence, even if it's the easiest pair.",
...

    {
      ...
      what: "Your first complete song. DOPE LEMON's Dope & Smoke alternates between two chord families — Am/Am7 and D/D7 — at 112 BPM with a mellow, behind-the-beat strumming feel. It's a two-chord song. The magic is in the lazy feel and the subtle shift from plain Am to Am7, plain D to D7. Hit play above and listen twice before touching the guitar — first time, just absorb the vibe. Second time, let your fretting hand ghost the chord changes without pressing the strings. Your motor system rehearses during focused listening.",
