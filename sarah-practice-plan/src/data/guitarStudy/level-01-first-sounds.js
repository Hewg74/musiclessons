...
export const level1 = {
  ...
  exercises: [
...

    {
      ...
      what: "Your first complete song. DOPE LEMON's Dope & Smoke alternates between two chord families — Am/Am7 and D/D7 — at 112 BPM with a mellow, behind-the-beat strumming feel. It's a two-chord song. The magic is in the lazy feel and the subtle shift from plain Am to Am7, plain D to D7. Hit play above and listen first.",
      setup: "Guitar. Metronome at 90 BPM (slow it down — original is 112). Listen to the song reference first.",
      steps: [
        ...
        { text: "Shape the pattern: miss the upstroke on beats 2 and 4 (arm still swings up, doesn't hit strings). Mix Am and Am7 freely — switch whenever it feels right. Same with D and D7. Listen to the song and match the feel.", why: "The missing upstrokes create rhythmic space — and space is where DOPE LEMON's groove lives. Mixing plain chords with 7ths freely (not on a schedule) gives you the organic, unhurried quality of the recording." },
        { text: "Play for 8 full cycles at 90 BPM. No stopping. If you miss a change, keep strumming and catch the next one. Then try 100, then 112 (the real tempo). If you can't get past 100 today, stop and try tomorrow — your brain consolidates overnight.", why: "Playing through mistakes is a critical skill. Speed increases should feel like graduating, not struggling. Sleep consolidation is real — 10-13% improvement happens overnight." }
      ],
      ...
      sarah: "Gene, Dope & Smoke is your #2 most-played track. Angus Stone plays simple chords with a feel that sounds like he just woke up from a nap — that's intentional behind-the-beat placement. The whole song is Am and D with 7th variations drifting in and out. Two chord families, zero flash, all feel. His major→minor trick (D-Dm, G-Gm) appears in other DOPE LEMON songs — you'll explore that in Level 12. For now, just Am-D-Am7-D7 with that sleepy, reverb-drenched vibe.",
