...
export const level1 = {
  ...
  exercises: [
...

    {
      ...
      type: "guitar",
      recorder: true,
      what: "Before training anything, capture an honest snapshot of where your guitar playing is today. This recording is sacred — you'll come back to it after Level 15 and hear a different person. No judgment, no warm-up, just raw truth.",
      ...
      steps: [
        ...
        { text: "Save this recording. Label it 'Guitar Baseline — Level 1 Start.' You will need it at Level 15.", why: "The comparison between this recording and your Level 15 Golden Hour Set will be one of the most satisfying moments in your guitar journey. Protect this artifact." }
      ],
...

    {
      ...
      steps: [
        ...
        { text: "Continue string by string: A string has D (5th fret) and E (7th fret). D string has G (5th fret) and A (7th fret). G string has C (5th fret). B string has D (3rd fret) and E (5th fret). High E string has A (5th fret) and C (8th fret). Say every note name as you play it. Take your time — accuracy over speed.", why: "Building the shape string by string makes it manageable. By the time you reach the high E string, your fingers have traced a map across the neck. This map is the same one Mark Speer navigates every night." },
...

    {
      ...
      steps: [
        ...
        { text: "G: middle finger on A string fret 2, index on low E string fret 3 (some people reverse these), ring finger on high E string fret 3. Strum all 6 strings. This is a big, open, resonant chord — let it ring.", why: "G major is the most resonant open chord on the guitar — all six strings ring. It's the key of Real Love Baby by Father John Misty and the landing chord of Dope & Smoke by DOPE LEMON. When you strum this chord and hear all six strings vibrate, that's the sound of a thousand songs." },
...

    {
      ...
      steps: [
        { text: "Before you play: close your eyes and HEAR a rhythmic phrase on A. Just one note, but hear the rhythm — where the hits land, where the silences breathe. Maybe 'da... da-da... da' or 'da-da-da... rest.' Tap it on your leg. Feel the groove in your body before the guitar enters. Then pick up the guitar and play EXACTLY what you heard internally. That's the difference between intentional playing and noodling.", why: "Hearing the phrase internally before playing is the audiation foundation. Most guitarists start by moving their fingers and hoping something good comes out. Reversing the order — hear first, then play — means every note is intentional. The leg tap bridges internal hearing to physical rhythm, and playing from audiation means the guitar confirms what your mind already created." },
...

    {
      ...
      levelUp: "Can execute a clean half-step bend on the B string (8th fret G# to 9th fret A pitch) with supporting fingers, hitting the target pitch accurately. Can add basic vibrato to a held note that sounds controlled, not shaky."
    },
...

    {
      ...
      steps: [
        ...
        { text: "Practice the intention cycle before each response: 1) HEAR — pick a note from the pentatonic internally, hear its pitch in your mind. 2) FEEL — sense where it lives on the fretboard, your fingers know the fret and string. 3) CHOOSE — what does this note express? A question? A sigh? An answer to the backing track? 4) PLAY — execute what you've already heard, felt, and chosen. This four-step cycle takes 2-3 seconds of silence. It's not slowing you down — it's making every note count.", why: "The hear-feel-choose-play cycle transforms reactive noodling into intentional improvisation. Without it, your fingers lead and your ear follows. With it, your ear leads and your fingers confirm. This is the difference between a guitarist who 'knows scales' and a musician who 'speaks music.' The 2-3 seconds of silence it requires is exactly the space that makes improvisation sound deliberate rather than random." },
...

    {
      ...
      steps: [
        ...
        { text: "Play a short pentatonic phrase on guitar (3-4 notes). Put the guitar down. Wait 5 full seconds in silence — not anxious silence, intentional silence. During those 5 seconds, replay the phrase in your mind: hear every note, feel the rhythm, sense the fretboard positions. Then sing it from memory. The 5-second gap is audiation training — it forces you to hold music internally without the instrument as a crutch. Try 3 different phrases, each with the 5-second silent gap.", why: "Playing a phrase, then singing it from memory, is the purest test of audiation. If you can do this, you can eventually hear phrases in your head BEFORE playing them — which is how improvisation becomes intentional instead of random." },
