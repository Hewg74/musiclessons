...
export const level8 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        { text: "Play Am arpeggio: A (open 5th string, thumb), C (3rd fret, 2nd string... actually, let's use the full chord shape). Fret Am: x02210. Play: thumb on A string (A), index on G string (E), middle on B string (C), ring on high E (E). One note per beat at 70 BPM. Let each note sustain and overlap.", why: "Finger plucking gives you dynamic control over each note. The overlapping sustain creates the lush, reverb-friendly sound that defines cinematic guitar." },
        { text: "Move to Dm: xx0231. Thumb on D string (D), index on G string (F), middle on B string (A), ring on high E (D). Same pattern, same tempo. Then Em: 022000. Thumb on low E (E), index on G string (G), middle on B string (B). Spend 2 minutes on each chord.", why: "These three minor chords form the harmonic backbone of most cinematic guitar music. As arpeggios, they become melodic phrases instead of static chords." },
