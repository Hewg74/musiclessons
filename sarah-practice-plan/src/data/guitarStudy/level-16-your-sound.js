...
export const level16 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Play 2 minutes of surf-psych: jangly open chords, tremolo picking, Am-G-F-E descending minor, reverb if you have it. Allah-Las territory. Notice how it feels in your body — do your shoulders drop? Does your continuous arm motion feel effortless, like breathing? Does the shimmer of open strings vibrating against your chest feel like home? Or does it feel like effort, like visiting a place you used to live?", why: "Your authentic sound is the one where technique disappears and feeling takes over. Surf-psych was your first guitar language (Level 1-3). The body knows — when your physical engagement feels natural and transparent, that's a sign this style is in your identity." },
        { text: "Play 2 minutes of reggae: offbeat skank, F-C-G or B-F#-E, muted chops, behind the beat. Elovaters and Susto territory. Feel the groove. Does your head nod naturally or are you counting?", why: "Reggae requires the deepest feel of any style — you can't fake the pocket. If the skank feels effortless and the muting is automatic, reggae is in your bones. If you're still thinking about it, it's a tool, not a home." },
    ...
    },
    {
      ...
      steps: [
        { text: "Identify your peak piece — which song or section in your set has the highest energy? It might be a Sun Room surf blast at 140 BPM, a Pepper reggae-rock switch, a fuzz-driven psych freakout, or an intense desert drone build. Play it at full intensity. Don't hold back. Feel your whole body engage — forearm driving the strum, shoulder opening up, the guitar body shaking against your chest with the force of your attack. This is the physical signature of your peak: the moment where every muscle participates.", why: "The peak is where performance energy matters most. In practice, you might play at 80% intensity. In your peak, you need 100% — and that means full-body engagement, not just hand-level intensity. Your physical relationship with the guitar IS your sound, and at the peak, that relationship is at its most visceral." },
    ...
    },
    {
      ...
      wrong: "If you're being harsh about the Level 1 recording, stop. That person was brave enough to start — and every awkward moment in that recording was your hands learning, not failing. If you're being dismissive about the Golden Hour Set ('it's not that good'), listen again with kinder ears. Compare it to where you STARTED, not to where your heroes are. You'll get there. You're already on the path.",
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "One more thing: play something — anything — that's completely improvised. No set list, no plan, no structure. Apply the audiation practice you've built across this curriculum: hear each phrase before you play it. Let your inner ear compose in real time. 5 minutes. This is where your sound lives when nobody's watching — when every note comes from audiation, not habit. Record it too.", why: "Pure audiated improvisation after a structured performance reveals your deepest musical instincts. The 30-minute set is what you can do with preparation. The 5-minute audiated improvisation is who you are without it — the Audiate-Play-Transfer protocol (Gordon Stage 6) applied to pure self-expression. Both matter. This final recording is the proof that your inner ear leads." }
      ],
      ...
      wrong: "If you're too nervous to start, remember: this recording is for you. Nobody else has to hear it. If the set falls apart midway through, finish it anyway — the act of completing it matters more than perfection. End on something you love — the last sound is what you'll carry with you. If it feels anticlimactic, listen back tomorrow with fresh ears. It will sound better than you think.",
