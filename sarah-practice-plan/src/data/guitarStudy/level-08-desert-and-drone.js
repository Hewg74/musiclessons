  ...
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "Full sus pentatonic chain: start on A, audiate the next note up (B), visualize its position, play it. From B, audiate D, visualize, play. From D, audiate E, visualize, play. From E, audiate G, visualize, play. Close eyes for audiation → open to check → close for next rep. Walk up the entire scale this way.", why: "Chaining audiation across the full scale builds a connected internal map rather than isolated note-to-note jumps. By the end, you've walked A-B-D-E-G with every note heard before it was played. This is Gordon Stage 6 in action: pre-hearing activates auditory cortex before motor cortex." },
