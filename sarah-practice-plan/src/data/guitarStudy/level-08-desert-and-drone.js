...
export const level8 = {
  ...
  exercises: [
...

    {
      ...
      feel: "This should feel meditative and precise — like archery with your ears. Each note is an intention, a visualization, and then an action. The desert drone grounds everything. When the audiated note matches the played note, there's a deep satisfaction — like an arrow hitting its target. The slowness is the practice.",
    ...
    },
    {
      ...
      wrong: "If you played fast and varied throughout, you missed the point. Desert blues is about restraint, patience, and depth. If you got bored and stopped early, try setting a timer and committing — the breakthrough happens after the boredom, not before it. Before you start: what will you listen for in the drone's overtones? After you finish: what surprised you about the 15 minutes?",
