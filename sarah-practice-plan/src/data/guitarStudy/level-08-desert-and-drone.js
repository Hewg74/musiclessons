...
export const level8 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        { text: "Let the drone ring. In the silence, hear a melody arise internally — 4 notes from the sus pentatonic (A-B-D-E-G). Don't reach for the guitar yet. Wait until the phrase feels vivid — until you could sing it. Then play it. This is your motif, born from audiation, not from finger patterns.", why: "Desert blues is inner-hearing music — the phrase exists in the player's mind before it reaches the strings. Audiating the motif before playing it ensures the phrase has a melodic identity independent of your finger habits. Pascual-Leone 1995 showed that mental rehearsal alone reshapes motor cortex maps. The motif doesn't need to be clever. Simple phrases become hypnotic through repetition." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Minutes 3-8: gradually evolve. Before each note change, let the drone ring in silence. Close your eyes. Hear the next note arise in your inner ear — don't search for it, let it come to you. When it's vivid, play it. Change one note every 90 seconds. Add quarter-tone bends. Move between registers while keeping the drone constant.", why: "Desert blues development is glacial and audiation-led. Letting notes arise internally over the drone is the Tinariwen way — the phrase reveals itself through patience, not through searching. Aarhus 2021 showed that combined imagery + playing creates equal learning in 1/3 the time. The whole 15 minutes might only use 6-7 different notes total — each one heard before it was played." },
