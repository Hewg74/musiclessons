...
export const level11 = {
  ...
  exercises: [
...

    {
      ...
      type: "guitar",
      what: "Learn three open-position 7th chords: Am7, Dm7, Em7. Each one is a triad you mastered in Level 6 with ONE extra note added — the 7th. Am7 is your Am triad (A-C-E) plus G. Dm7 is your Dm triad (D-F-A) plus C. Em7 is your Em triad (E-G-B) plus D. The 7th note adds warmth, sophistication — like adding cream to coffee. Same drink, richer flavor.",
      setup: "Guitar. No metronome yet — focus on shapes first.",
      chordVoicings: { chords: ["Am7", "Dm7", "Em7"] },
      steps: [
        { text: "Play Am (x02210). Now lift your ring finger off the 3rd string (G string) — you're playing Am7 (x02010). Strum both back to back. Am is clean and definitive. Am7 is softer, warmer, slightly unresolved. The open G string adds the 7th (G natural).", why: "Am7 is the easiest 7th chord to learn because it's Am with LESS effort — you remove a finger. The 7th (G) is already waiting on the open G string. This is why open-position 7ths are magic on guitar — the open strings do the work." },
    ...
    },
    {
      ...
      type: "guitar",
      what: "Play Am then Am7. Dm then Dm7. Em then Em7. Back and forth, slowly. You spent Level 6 mastering these triads — now hear what ONE extra note does. The 7th adds warmth, motion, and a subtle pull. Train your ear to recognize the color change, like distinguishing between blue and blue-gray.",
      setup: "Guitar. Metronome at 70 BPM. Quiet room — you need to hear the overtones.",
      chordVoicings: { chords: ["Am", "Am7", "Dm", "Dm7", "Em", "Em7"] },
      steps: [
        { text: "Strum Am for 4 beats. Then Am7 for 4 beats. Repeat 4 times. Close your eyes. Listen for the extra note — the G on the 3rd string (G string) that opens up when you lift your ring finger. Am is a closed statement. Am7 is a question.", why: "Training your ear to distinguish triads from 7ths is the foundation of harmonic awareness. When you can HEAR the 7th, you'll start hearing it everywhere — in Skinshape, in Khruangbin, in every soul record." },
        { text: "Same thing with Dm and Dm7. 4 beats each, 4 repetitions. The Dm7 should sound smokier, jazzier, more complex. The added C note creates a pull — Dm7 wants to move somewhere.", why: "Dm to Dm7 is a more dramatic color change than Am to Am7 because the 7th (C) is a whole step below the root (D). That close interval creates harmonic friction — beautiful friction, the kind that makes jazz sound like jazz." },
    ...
    },
    {
      ...
      fretboard: { scale: "a-dorian", position: 1, chordToneNotes: ["A", "C", "E"] },
    ...
    },
    {
      ...
      sarah: "Gene, this exercise is where everything from Level 11 converges. Ghost notes from Skinshape, Dorian from soul music, space from Khruangbin, 7th chords from jazz. You're not playing a genre — you're playing YOUR sound, built from all your influences. The recording of this improv will sound different from anyone else's because your mix of influences is unique. Tap 'Draw new progression' below — Dorian Soul Improv should work over ANY dorian cycle. Prove the scale vocabulary isn't locked to Am7-Dm7-Em7. Khruangbin's im-bVIImaj7, a longer dorian rock, a dorian i-IV. Same melodic instinct, new harmony.",
      chordProgression: {
        key: "A",
        scale: "dorian",
