export const level5 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Place your index finger flat across all six strings at fret 5. Don't press yet — just lay it there. Now press down with moderate pressure and strum all six strings slowly, one at a time, from low E to high E. Listen for buzzes, mutes, dead notes. Mark which strings ring clean and which don't.", why: "Isolation before chord shapes means you fix the foundation first. Most barre chord frustration comes from skipping this step and blaming strength — it's almost always technique, not muscle." },
      ...
      wrong: "If your hand cramps within 10 seconds, you're using brute force instead of technique. Check: is your thumb behind the barre? Are you using the bony side? Is your elbow pulled in? If strings still buzz after all adjustments, it might be your guitar's action — have a teacher or shop check the setup.",
    ...
    },
    {
      ...
      steps: [
        { text: "Start with the E-shape minor barre at fret 1 (Fm). Strum 4 beats. Slide the whole shape up one fret to fret 2 (F#m). Strum 4 beats. Continue: Gm (fret 3), G#m (fret 4), Am (fret 5), and so on up to fret 12 (Fm again, one octave higher). Listen to the key rise with each fret.", why: "The chromatic escalator proves that every fret is a half step and every barre position is a valid chord. This physical experience teaches neck geography more effectively than memorizing a fret chart." },
...

    {
      ...
      type: "guitar",
      what: "Sun Room's Sol Del Sur is a three-chord barre masterpiece: C#m-B-F# (i-bVII-IV in C# minor). The F# is major — borrowed from the parallel major key, creating that Mixolydian ambiguity that gives the song its restless, sun-drenched ache. This is the anchor song of Level 5. Learn it, feel it, own it.",
      ...
      sarah: "Gene, this is IT. Sol Del Sur is track #45 in your top 50, and it's the perfect barre chord vehicle. Luke from Sun Room plays a Jazzmaster with the Tubescreamer always on — low gain, just warming the signal, tone shaping. Through a Fender Deluxe Reverb. His philosophy is 'simple is better' — three chords, one syncopated strum, let the song breathe. That C#m-B-F# is the i-bVII-IV pattern you'll hear everywhere in psych-surf once you know to listen for it. The F# being major instead of minor is the secret ingredient — it's borrowed from the parallel major key, creating this Mixolydian ambiguity that makes the song restless and hopeful at the same time.",
      metronome: 70,
      recorder: true,
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Dynamic shift: after 8 bars, drop to palm-muted ghost strums — same chords, same pattern, but barely audible. Muted, percussive, all rhythm and no ring. Hold this for 8 bars. Then open up to full volume. Feel the contrast.", why: "Dynamic contrast is what makes a 5-minute jam interesting. The whisper-to-roar shift creates dramatic arc without changing a single note. This is how Sun Room builds tension in their live sets." },
      ...
      wrong: "If the jam sounds like a practice loop (same volume, same strum, same energy for 5 straight minutes), force yourself to change something every 8 bars. Louder, quieter, muted, open, downbeat emphasis, upbeat emphasis. The jam needs an arc — beginning, middle, climax, resolution.",
