export const level5 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Place your index finger flat across all six strings at fret 5. Don't press yet — just lay it there. Feel the six strings pressing into your finger — six distinct lines of pressure, each a slightly different thickness. This is the most intimate contact you'll have with the instrument: one finger spanning the entire width of the neck, every string a different conversation with your skin. Now press down with moderate pressure and strum all six strings slowly, one at a time, from low E to high E. Feel how each string responds differently under your finger — the thick low E requires firm pressure and buzzes the guitar body deep into your chest, the thin high E barely needs anything and shimmers lighter. Listen for buzzes, mutes, dead notes. Mark which strings ring clean and which don't.", why: "Isolation before chord shapes means you fix the foundation first. The awareness of six distinct pressure points on one finger is the physical architecture of barre chords — your whole hand pressed against the neck is a physical commitment, every finger with a role. Most barre chord frustration comes from skipping this step and blaming strength — it's almost always technique, not muscle." },
...

    {
      ...
      steps: [
        ...
        { text: "Place your index finger barre at fret 2. Feel the whole neck under your hand — your thumb presses into the back, your index spans all six strings, your hand wraps the neck like a handshake. Now add your ring finger on string 4 fret 4, pinky on string 3 fret 4, middle finger on string 2 fret 3. Strum strings 5 through 1. This is Bm — the same Am shape, moved up 2 frets. Feel how the chord vibrates through the barre finger into your hand — the resonance travels differently through a gripped neck than through open strings.", why: "The fingering shifts from the open Am: what was index-middle-ring becomes middle-ring-pinky, because the index finger is now the barre. This new fingering feels awkward at first but becomes second nature. The full-hand engagement — barre, thumb, three chord fingers — means your entire hand participates in the sound." },
        { text: "Slide the same shape to fret 4. Now it's C#m — the main chord in Sol Del Sur. Strum it slowly, feel the guitar body resonate with this new pitch center — darker and richer than Bm, the wood buzzing warmly against your chest. Fix any buzzes. Then slide to fret 5 — that's Dm. Fret 7 — Em. Same shape every time, different fret = different chord. Notice how the string tension eases as you climb — higher frets feel softer under your fingers, the fret spacing narrows, and the resonance brightens.", why: "Sliding the same shape to different frets is the 'moveable nut' concept in action. You don't learn new shapes — you learn new positions. The changing tension and resonance at each fret creates a physical map — your fingers learn to associate each position with a specific feel and sound weight." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Slide the B shape up to fret 4 — that's C# major. Up to fret 9 — F# major. F# at fret 9 is one of the easier positions because the frets are close together and string tension is low. This is the F# in Sol Del Sur.", why: "F# major at fret 9 is easier than B major at fret 2 — shorter fret spacing means less stretch. But Sol Del Sur uses F# at fret 2 (E-shape, root on string 6) because it's closer to the C#m and B positions. You'll work up to that." },
        { text: "Alternative F# position: barre at fret 2 with the E-shape (root on string 6 — fret 2 on the low E = F#). This puts F# right next to B (A-shape at fret 2, rooted on string 5). Practice placing B at fret 2, then F# at fret 2 — different shapes, different root strings, same fret.", why: "Having B and F# both accessible near fret 2 means minimal hand movement during Sol Del Sur. The C#m is at fret 4 (E-shape). The whole progression lives in a 3-fret zone. This is why barre chords are efficient — close positions, minimal travel." },
        { text: "Play all three Sol Del Sur chords in sequence: C#m (E-shape, fret 4) → B (A-shape, fret 2) → F# (E-shape, fret 2). Very slowly, one chord per 4 beats. Focus on clean transitions, not speed. If any chord buzzes, stop and fix it before moving on.", why: "This is the first time you're combining both barre shapes in a real song context. The transition from E-shape (C#m) to A-shape (B) is the hardest part — different hand positions, different string roots. Slow practice here pays dividends." }
      ],
      ...
      metronome: 50,
      levelUp: "B major (A-shape, fret 2) and F# major (E-shape, fret 2 or A-shape, fret 9) ring clean. Can play C#m → B → F# at 50 BPM, one chord per bar, with no dead strings."
    },
...

    {
      ...
      steps: [
        ...
        { text: "Pair 3: B (A-shape, fret 2) ↔ F# (E-shape, fret 2). Same fret, different shapes — but the barre stays at fret 2 for both. Set timer, count. This should be faster than Pair 2 because the hand stays near the same fret.", why: "B to F# at fret 2 keeps your hand in one zone — you just switch between A-shape (root on string 5) and E-shape (root on string 6). Once this pair is fast, two-thirds of the song's transitions are handled." },
...

    {
      ...
      songRef: {
        ...
        src: "/sol-del-sur.mp3",
        note: "The barre chord anthem — C#m-B-F# at 138 BPM. All barre shapes, no open chords."
      },
      ...
      metronome: 70,
      speedLadder: { start: 50, end: 138, increment: 10, bars: 4 },
      recorder: true,
      levelUp: "Can play Sol Del Sur (C#m-B-F#) at 120+ BPM with the syncopated strum pattern, no dead strings, chord changes on time. Recorded play-through sounds like the song."
    },
    {
      id: "gs-5-7",
      time: 8,
    ...
    },
    {
      ...
      songRef: {
        ...
        note: "Listen to the energy — ~160 BPM, driving strum. This is Sun Room at full throttle. Match the urgency."
      },
      what: "Sun Room's Sunset Garage uses G-Em-C-D in the verse and C-D-G-Em in the chorus — all open chords, but at ~160 BPM it's the fastest song in this level. Speed with clean transitions is the challenge. Your barre chord skills from Sol Del Sur prepare your hand for fast transitions — now apply that snap-and-release speed to open chord changes.",
      setup: "Guitar. Metronome at 110 BPM, target ~160.",
    ...
    },
    {
      ...
      tracks: [{ name: "Sol Del Sur", src: "/sol-del-sur.mp3" }],
      steps: [
        { text: "Start clean: C#m-B-F# with the syncopated strum at 90 BPM. Let the groove establish. Before you play, hear the C#m chord in your mind — its dark, minor weight. Then form the shape and strum. Feel your hand gripping the neck at fret 4, the barre pressing six strings, the chord vibrating through your clenched hand into the guitar body and against your chest. Play 8 bars of steady, clean rhythm. This is the foundation — nothing fancy, just locked-in time.", why: "Starting clean and steady gives you a baseline to depart from. Hearing the chord before forming it trains audiation even during rhythm work. The full-hand engagement of barre chords means the vibration travels through your grip — your hand IS part of the resonating system." },
