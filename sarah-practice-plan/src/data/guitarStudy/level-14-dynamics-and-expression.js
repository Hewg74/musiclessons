...
export const level14 = {
  ...
  exercises: [
...

    {
      ...
      what: "Current Swell's 'Marsha' is a 6-chord song (Dm-C-G-F-Bb-D) at 108 BPM with a distinctive intro riff and the D→Dm magic moment. The song starts intimate and builds to full band power — a complete dynamic arc in 4 minutes. You'll learn the chords, the intro riff, and most importantly, the dynamic shape that makes this song breathe.",
      setup: "Guitar. Metronome at 90 BPM (learn slow, target 108). Capo optional.",
      steps: [
        ...
        { text: "Learn the intro riff from tab (search 'Marsha Current Swell tab' on Ultimate Guitar — the intro is a distinctive melodic figure). Play it at 90 BPM until clean, then work up toward 108. The intro should sound like a voice calling out. Record the full song: intro → verse (quiet) → verse (medium) → verse (full) → D→Dm moment.", why: "The intro riff anchors the song — it's what makes 'Marsha' immediately recognizable. Learning it from tab rather than from chord shapes builds your ability to read and play specific melodic lines. The full song performance ties together everything in this level." }
      ],
...

    {
      ...
      steps: [
        { text: "Learn the three chords: D (xx0232), G7 (320001), A (x02220). The G7 is key — it's a regular G shape but move the pinky from fret 3 down to fret 1 on the high E string — that F note is the flat 7th of G. Strum each chord 4 times to lock the shapes.", why: "G7 is the chord that makes this song interesting. A plain G would sound like a thousand other songs; the flat 7th adds a bluesy, slightly unresolved quality. It's like the G chord has a question mark at the end." },
      ...
      wrong: "If the shuffle feels stiff, you're thinking about it too much. Tap your foot and let your arm swing naturally — the shuffle will emerge. If the G7 sounds the same as plain G, check that the high E string is at fret 1 (F note), not fret 3 (G note). If the dynamic arc is flat, commit harder to the quiet sections — level 2 should be barely audible.",
