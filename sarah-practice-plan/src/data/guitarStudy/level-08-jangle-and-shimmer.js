...
export const level8 = {
  ...
  unlocks: "The Groove Machine (Level 9)",
  review: {
    label: "Level 7 Check-In",
    time: 5,
    exercises: ["gs-7-5", "gs-7-8"],
    prompt: "Play the voice-led chord tones exercise (gs-7-5). Then play your chord tone solo over Dope & Smoke (gs-7-8). Can you target chord tones and connect them with scale notes? Time for jangle."
  },
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "Strum Cmaj7 and let it ring for 4-5 seconds. Don't mute anything. Let the open strings ring — feel how the sustain lives in the guitar body, vibrating against your chest like a warm hum. Close your eyes and listen to the overtones — the way the open strings interact with the fretted notes creates a wash of sound that you feel as much as hear.", why: "Sustain is the point. In barre chord exercises you learned to fret cleanly. Now you learn to let go — open strings ringing freely create harmonic richness that fretted notes can't match. The chest vibration from sustained open strings is qualitatively different from muted or fretted sounds — it's warmer, wider, more alive." },
    ...
    },
    {
      ...
      type: "guitar",
      what: "Learn Dmaj7 (xx0220). From D major, move the B string from fret 3 down to fret 2 (adding C#, the major 7th) and lift the high E string open. The open E rings on top while C# underneath creates that dreamy maj7 quality — the same harmonic color as Cmaj7, in a new key.",
      setup: "Guitar. Metronome at 70 BPM.",
      chordVoicings: { chords: ["Dmaj7"] },
      steps: [
        { text: "Play a regular D major chord (xx0232). Strum it, feel its brightness. Now move your ring finger from fret 3 to fret 2 on the B string, and lift your middle finger off the high E string. The shape is now xx0220 — C# on the B string (the major 7th) with the open high E ringing on top. Strum and listen.", why: "Two small changes transform the chord. The C# on the B string (fret 2) is the major 7th of D — it creates the dreamy, unresolved quality. The open high E on top adds shimmer, just like in Cmaj7. Both chords share that ringing open E as a jangle thread." },
        { text: "Strum Dmaj7 and let it ring. Compare it to D major. Back and forth, 4 times. D major sounds bright and complete. Dmaj7 sounds bright but unfinished — there's a gentle yearning in it, a forward lean.", why: "The maj7 interval in D (C# against D) creates the same gentle dissonance as in Cmaj7 (B against C). Your ear is learning to recognize this quality regardless of the root note — that's interval recognition developing." },
        ...
        { text: "Notice something: both Cmaj7 and Dmaj7 have the open high E string ringing on top. That one string — the thinnest, brightest string on the guitar — is the shimmer thread connecting BOTH chords. Over C, it's the 3rd. Over D, it's the 9th. The maj7 quality comes from a different note in each chord (B in Cmaj7, C# in Dmaj7), but the open E is the jangle constant.", why: "This insight is the conceptual breakthrough of jangle guitar: the open high E string is a fixed drone that changes harmonic function depending on the chord underneath it. The maj7 interval provides the dreamy quality, and the open E provides the continuous shimmer. One string, multiple harmonic roles." }
      ],
      ...
      wrong: "If it sounds like a regular D, check that the B string is at fret 2 (not 3) and the high E is open. If the open E sounds harsh or jangling (in a bad way), you might be strumming too hard — jangle comes from letting strings vibrate, not from attacking them.",
      sarah: "Gene, here's the beautiful thing: Allah-Las built their entire sound on this one insight. The open high E string rings through both Cmaj7 and Dmaj7. When they float between these two chords, that ringing E string is the constant — the shimmer thread that connects them. It's the simplest trick in guitar, and it sounds like a million dollars through a Twin Reverb.",
      metronome: 70,
      levelUp: "Strum Dmaj7 (xx0220) 8 times at 70 BPM with the open high E ringing clearly, and explain how the open high E serves different harmonic roles over each chord (3rd over C, 9th over D) while the maj7 note (B in Cmaj7, C# in Dmaj7) provides the dreamy quality."
    },
...

    {
      ...
      steps: [
        { text: "Play Cmaj7 (x32000) for 2 bars. Then Dmaj7 (xx0220) for 2 bars. Back and forth. Go SLOWLY — 65 BPM. Let each chord ring fully before changing. Listen to the open E string sustaining through both chords.", why: "The slow tempo forces you to hear the transition. The open E never stops — it rings through the chord change as a continuous thread. This sustained open string is literally 'the jangle.'" },
        { text: "Focus on the transition itself. As you move from Cmaj7 to Dmaj7, the 3rd fret on the A string lifts and the 2nd fret on the G string adds. But the open high E NEVER changes — it rings through both chords as a constant pedal tone.", why: "Identifying which fingers move and which strings stay open builds efficient transitions. The fewer fingers that move, the smoother the change — and the open strings act as a bridge, sustaining through the transition gap." },
      ...
      feel: "The float should feel like being on a slow ocean swell — gently rising and falling, never arriving, never leaving. Both chords feel equally warm and equally unfinished. The open E string is the horizon line that never moves. Before you start: what will you listen for in the open strings? After 2 minutes: what did you notice about the shimmer?",
      ...
      sarah: "Gene, this is IT. The Cmaj7-Dmaj7 float is the Allah-Las sound. Pedrum plays his 1970s Fender through the Twin Reverb Blackface with the spring reverb cranked, and this two-chord progression fills the entire room. The open high E string is the secret — it rings constantly while the chords shift underneath, connecting them with one shimmering thread. That's the whole recipe. It's not complicated. It's just beautiful.",
      metronome: 65,
    ...
    },
    {
      ...
      steps: [
        { text: "Verse: play Cmaj7→Dmaj7 in a loop, 2 bars each, with the jangle strum you learned in gs-8-3. This IS the verse of Worship the Sun. The entire verse is this two-chord float. Play it 4 times through (16 bars).", why: "Learning that a professionally recorded, critically acclaimed song uses the exact same two-chord pattern you just practiced proves that simplicity works. Allah-Las didn't need more chords — they needed the RIGHT two chords." },
...

    {
      ...
      steps: [
        { text: "Play D major (xx0232). Feel the middle finger pressing the high E string at fret 2 — that F# (the major 3rd) defines the chord as major. Now lift that finger: Dsus2 (xx0230). The string goes slack under your fingertip as you release. Strum both back and forth. D major is definitive, the guitar body resonates with warm certainty. Dsus2 is ambiguous — the resonance opens up, becomes wider, less focused against your chest. One finger lifted, and the whole physical character of the chord shifts.", why: "The 3rd is the note that defines major vs. minor. Removing it creates a chord that's neither — it's suspended, unresolved, waiting. The physical release of lifting that finger mirrors the harmonic release — the chord literally opens when your finger does." },
    ...
    },
    {
      ...
      steps: [
        { text: "Play Em (022000). Then Dmaj7 (xx0220). Back and forth, 2 bars each, at 80 BPM first. Listen to how the open E string sustains through BOTH chords — in Em it's the root, in Dmaj7 it's the maj7. Same string, completely different harmonic function.", why: "This is the deeper version of the open string trick: the E doesn't just ring — it changes meaning depending on the chord underneath. In Em, E is home. In Dmaj7, E is the dreamy 7th. Your ear starts to hear one string doing two different jobs." },
        { text: "Now try the actual verse technique: move your hand up to the 7th fret area. Play hammer-ons and pull-offs on the G, B, and high E strings around frets 5-7 that outline the Em tonality — you're NOT holding the open Em shape anymore, your hand is up the neck. Then slide down to the 5th fret area for Dmaj7 — same idea, single notes and double-stops that outline the chord. The feel is swung, behind-the-beat — never rushed.", why: "This riff-over-chord technique is how levitation room creates their signature sound. The chord shape is the skeleton; the hammer-ons and pull-offs are the melody. It's not strumming — it's composing a riff that lives inside the chord. The behind-the-beat feel gives it that lazy, golden-hour quality." },
...

    {
      ...
      steps: [
        { text: "Play D major (xx0232). Hold it, strum it 4 times. Feel the brightness — the guitar body hums with a warm, resolved resonance against your chest. Now move your ring finger down one fret — from fret 3 to fret 2 on the high E string: xx0231, D minor. Feel how that half-fret shift changes the tension under your fingertip — barely any physical distance, but strum it 4 times and the entire emotional world changes. The resonance in the guitar body darkens, the vibration against your chest becomes more subdued, more inward.", why: "The major→minor shift is one of the most powerful emotional moves in popular music. The 3rd degree (F# vs. F) is the ONLY note that changes, but it transforms the chord's entire character. The physical micro-movement — one fret, one fingertip — creating such massive emotional change is something you feel in the body before you name it in the mind." },
    ...
    },
    {
      ...
      type: "guitar",
      what: "Record a 5-minute jangle jam using everything from this level. You can use your own progression from gs-8-11, combine it with song progressions you learned, or shift between different progressions mid-jam. The only rule: open strings ring. Let the shimmer build. This is your Level 8 graduation piece.",
      ...
      steps: [
        { text: "Choose your starting progression. It can be Cmaj7-Dmaj7 (the Allah-Las float), Em-Dmaj7 (Friends), your own creation, or anything else from this level. Start playing and don't stop for 5 minutes. Let the open strings ring — feel how the sustained shimmer vibrates continuously through the guitar body against your chest, a warm presence that builds with each repetition. The timer is running. Record.", why: "Five minutes is longer than most people play without stopping. The extended duration forces you past the 'performing' phase into the 'playing' phase — where you stop thinking about chord names and start feeling the music in your body. The continuous vibration of open strings against your chest becomes a physical anchor that keeps you present." },
        { text: "After 2 minutes, introduce a change: shift to a different progression, add a chord, change the strum pattern, alter the dynamics. But before making the change, check: did you HEAR the change in your mind, or are your fingers just restless? If you heard it — if the new chord or pattern was vivid in your inner ear — follow it. If you're just bored and grasping, wait until a genuine musical idea arises.", why: "The distinction between 'I heard a change' and 'I'm bored and grabbing' is the audiation diagnostic for mid-level players. Spontaneous musical decisions are the foundation of improvisation — but only when they originate from inner hearing, not from restlessness. Training yourself to notice the difference builds intentional improvisation." },
      ...
      recorder: true,
      levelUp: "Record a 5-minute jangle jam using at least 3 different chord voicings from Level 8, with at least one major→minor shift, dynamic variation, and a deliberate ending — then identify your best 30-second stretch."
    }
  ]
};
