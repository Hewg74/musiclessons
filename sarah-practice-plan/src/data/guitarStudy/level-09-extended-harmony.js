  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Now add the bridge: Am-G (4 bars) → Em (4 beats) → D (4 beats) → Bm (4 beats) → hold (4 beats). The bridge opens up the harmony — Em and D add brightness, Bm adds weight. The hold bar lets the progression breathe before cycling back.", why: "The bridge breaks the Am-G trance with new harmonic territory. Em-Bm creates a wider harmonic arc — you're traveling further from home before returning. This is Speer's songwriting at its most elegant: minimal chords, maximum emotional range." },
      ...
      metronome: 90,
      recorder: true,
      levelUp: "Play the Am-G verse vamp with 2-3 Dorian melody notes per bar at 111 BPM, transitioning smoothly to the Em-Bm bridge, with at least 50% silence in the melody part — confirmed by recording."
    },
