...
export const level9 = {
  ...
  exercises: [
...

    {
      ...
      feel: "Each 7th chord should feel like the regular triad put on a velvet jacket. Same bones, richer texture. When you strum Am7 and let it ring, it should feel warm and slightly dreamy — like the room got dimmer and more intimate.",
      ...
      sarah: "Gene, Skinshape builds his entire sound on 7th chords — he almost never plays bare triads. When you hear that warm, sophisticated, slightly jazzy quality in 'I Didn't Know,' it's because every chord has the 7th. Will Holland records drums first, then improvises guitar over the groove, and that guitar is almost always 7th voicings with a Lee Perry dub influence underneath. You're learning his vocabulary.",
      metronome: null,
      levelUp: "Play Am7, Dm7, and Em7 cleanly with no buzzing, cycling between them on 4-beat changes, and describe the sonic difference between each 7th chord and its triad."
    },
    {
      id: "gs-9-2",
      time: 7,
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Gm7: barre all six strings at fret 3 with your index finger. Add your ring finger at fret 5 on the 5th string. Pinky at fret 5 on the 4th string. Middle finger at fret 4 on the 3rd string. Shape: 353333. This is the Em7 shape moved up 3 frets. Strum from the 4th string down.", why: "Gm7 is the toughest voicing in this level — a full barre with a specific finger pattern. It's built on the Em7 barre shape. If your Level 5 barre work was solid, this is the same muscle, new shape. Start at fret 5 if fret 3 is too tight, then slide down." },
    ...
    },
    {
      ...
      steps: [
        { text: "Play A natural minor ascending: A-B-C-D-E-F-G-A. Now play A Dorian: A-B-C-D-E-F#-G-A. The ONLY difference is F vs F#. Play both scales back to back three times. Listen for the moment the mood shifts — that F# is where the brightness lives.", why: "Isolating the single note difference between natural minor and Dorian makes the scale change tangible. You're not learning a 'new scale' — you're upgrading one note. F# instead of F. That's it." },
        ...
        { text: "Improvise using ONLY four notes: A, C, E, F#. Root, minor 3rd, 5th, and the Dorian 6th. These four notes capture the entire Dorian color in a pentatonic-sized palette. Play freely for 2 minutes over the drone.", why: "Four notes is manageable and reveals the Dorian flavor clearly. The A-C gives you minor, the F# gives you Dorian brightness. This subset is the backbone of soul and funk guitar — Carlos Santana lives in these four notes." },
    ...
    },
    {
      ...
      type: "guitar",
      what: "Khruangbin and Leon Bridges' 'Texas Sun' sits on Am-G for the verses and opens up to Em-D-Bm for the bridge. At 111 BPM, it's a slow-burning soul groove. The guitar part is NOT a strum — it's Speer-style single-note melody lines floating over the chord changes. Your job: play the chord changes, then add melody on top, then combine them.",
      setup: "Guitar. Metronome at 90 BPM (build to 111). Volume at 7, tone at 5-6 — warm, not bright.",
      chordVoicings: { chords: ["Am", "G", "Em", "D", "Bm"] },
      ...
      steps: [
        ...
        { text: "Now add the bridge: Am-G (4 bars) → Em (4 beats) → D (4 beats) → Bm (4 beats) → hold (4 beats). The bridge opens up the harmony — Em and D add brightness, Bm adds weight. The hold bar lets the progression breathe before cycling back.", why: "The bridge breaks the Am-G trance with new harmonic territory. Em-D-Bm creates a wider harmonic arc — you're traveling further from home before returning. This is Speer's songwriting at its most elegant: minimal chords, maximum emotional range." },
        { text: "Switch to single notes: over the Am-G vamp, play melody notes from A Dorian (A-B-C-D-E-F#-G) on the top 2 strings. Start with just 2-3 notes per bar — long, sustained, with space between them. Think of each note as a sentence, not a word.", why: "Mark Speer's guitar melodies are famously sparse. He plays one note, lets it ring for a full beat or more, then plays the next. The melody breathes like a vocal line. Playing too many notes is the most common mistake when trying to sound like Khruangbin." },
      ...
      metronome: 90,
      recorder: true,
      levelUp: "Play the Am-G verse vamp with 2-3 Dorian melody notes per bar at 111 BPM, transitioning smoothly to the Em-D-Bm bridge, with at least 50% silence in the melody part — confirmed by recording."
    },
    ...
    },
    {
      ...
      steps: [
        { text: "Start with 4 bars of Am7 ghost-note groove — ring-chk-ring-chk pattern. Establish the rhythmic pocket. Don't rush. Let the backing track carry you.", why: "Starting with the groove establishes the rhythmic foundation. Everything else is built on top of this pocket. If the groove isn't solid, nothing on top will feel right." },
        { text: "After 4 bars of groove, switch to 2 bars of Dorian melody: play single notes from A Dorian on the top 2 strings. 2-3 notes only, with space. Then drop back into 4 bars of groove. Alternate: groove → melody → groove → melody.", why: "Alternating between rhythm and melody is how soul guitarists function in a band. You're the rhythm section when you groove and the soloist when you play melody. Switching between roles builds the musical multitasking that defines great guitar playing." },
