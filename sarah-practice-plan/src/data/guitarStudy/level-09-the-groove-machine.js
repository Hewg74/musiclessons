...
export const level9 = {
  ...
  unlocks: "Desert & Drone (Level 10)",
  review: {
    label: "Level 8 Check-In",
    time: 5,
    exercises: ["gs-8-3", "gs-8-11"],
    prompt: "Play the Cmaj7→Dmaj7 float with open strings ringing (gs-8-3). Then play your own jangle chord progression (gs-8-11). Shimmer is in your fingers? Time for some grit."
  },
  exercises: [
...

    {
      ...
      steps: [
        ...
        { text: "On beat 1 of bar 5, stomp the distortion and slam into power chords: A5 for 2 bars, then D5 for 2 bars. Full downstrokes, palm-muted but letting each hit ring slightly longer than the skank. Feel the transformation in your body — your whole physical engagement changes. The wrist-snap of the skank becomes a forearm-driven power stroke. The quiet chest vibration of muted offbeats becomes the thundering resonance of amplified fifths. From whisper to shout, and your body knows the difference before your ears do.", why: "The power chord section is the RELEASE. The physical shift — from wrist-centered skank to forearm-driven power — is the embodied version of the SoCal switch. Your body experiences the genre change as a change in posture, muscle engagement, and resonance. Think Pepper's Stormtrooper when the chorus hits." },
      ...
      sarah: "Gene, this is the move that powers YOUR music — the reggae-rock energy you play on repeat lives right here. This is the entire Pepper formula. Stormtrooper, Stitches, Give It Up — they ALL do this switch. The Hip Abduction too. It's the same move you hear in Slightly Stoopid's live sets when they shift from mellow island vibes to full rock energy. You already have both halves — the skank from Level 4, the power chords from Level 3. This exercise welds them together.",
      metronome: 90,
    ...
    // SONG CHORDS UNVERIFIED — verify from tabs before playing along with the recording
    {
      ...
      steps: [
        { text: "Learn the three shapes: D#5 at fret 11 (power chord on strings 6-5), A#5 at fret 6 (same shape), F#5 at fret 2 (same shape). Just hold each one, strum it, make sure it rings clean. These are the same power chord shape from Level 3, just in three positions.", why: "Power chords are moveable shapes — same two fingers, different frets. The riff is really about SLIDING one shape to three positions. Understanding this means you can write your own power chord riffs by choosing any three frets." },
      ...
      chordVoicings: { chords: ["D#5", "A#5", "F#5"] },
      recorder: true,
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Engage mild overdrive. Play the same skank pattern on A. Notice how the overdrive thickens the chop — it has more body, more grit, and the guitar body buzzes differently against your chest: warmer, fuller, more saturated than the clean chop. BUT the note should still be SHORT. Mute immediately after each chop — feel your palm clamp down on the strings, silencing the vibration at the bridge. The overdrive makes sustain easier, so you have to mute HARDER. Your palm becomes a gate: open (strum) → shut (mute) → open → shut.", why: "Overdrive amplifies sustain — which is the enemy of a good skank. The skank's power is its brevity: chop-mute, chop-mute. With overdrive, your muting hand has to work twice as hard to keep each hit short. The physical feedback loop — feeling the vibration bloom under your palm and then clamping it dead — is your body's metronome for mute timing." },
...

    {
      ...
      what: "Put the pieces together into a full Stormtrooper-style arrangement. Power chord intro (gs-9-2), drop into clean reggae skank for the verse, distorted power chords for the chorus, clean skank outro. This is a full song structure built from the techniques you've been drilling.",
...

    {
      ...
      steps: [
        ...
        { text: "Before you touch the guitar, hear a note in your mind — one pitch that belongs over this groove. Sing it quietly. THEN find it on the fretboard (it'll likely be A or C from Am pentatonic, position 1). Hold it over the groove. Bend it slightly. Add a second note the same way: hear it, sing it, find it. Two notes chosen by your ear, not your fingers.", why: "Starting from audiation — hear it, sing it, play it — ensures your first notes in the groove are intentional. The Aarhus 2021 study showed this three-step process (imagine → vocalize → execute) produces equal skill in 1/3 the time of fingers-first playing. Two audiated notes over a reggae groove will lock in deeper than ten random notes because they came from your inner ear." },
      ...
      wrong: "If your solo sounds disconnected from the groove, you're not listening to the backing track. Stop playing, listen for 30 seconds — feel the groove in your body before your fingers touch the strings — then re-enter with ONE note that locks into the rhythm. If you're playing too many notes (shredding), simplify — the reggae groove doesn't want a metal solo. It wants space, feel, and blues bends.",
    ...
    },
    {
      ...
      steps: [
        { text: "Start the continuous 16th-note strum: D-U-D-U-D-U-D-U, every note even. Your arm moves in a constant, rapid pendulum — feel the motion live in your forearm, a continuous flow from elbow to wrist. No pauses, no ghost strums — every stroke hits the strings. The guitar body vibrates without pause against your chest, a steady warm hum that becomes your physical metronome. Play on B major only until the motion is automatic.", why: "This is the opposite of reggae. In Level 4, you learned to strum ONLY on upbeats with muting between. Here, every single 16th note is voiced. The arm never stops and never misses. The unbroken chest vibration is the somatic signal that you've achieved true continuity — any gap in the buzz means a missed stroke." },
    ...
    },
    {
      ...
      type: "guitar",
      what: "Your Level 9 capstone. Build a 3-4 minute SoCal reggae-rock piece from scratch using everything you've learned: clean skank, distorted skank, power chord riff, pentatonic solo, dynamic contrast, and the SoCal switch. Record the whole thing as one take. This is YOUR reggae-rock song.",
      ...
      steps: [
        ...
        { text: "Record the full piece in one take. If you make a mistake, keep playing — a recovered mistake sounds more live and human than a stopped recording. Listen back when you're done. This is your Level 9 graduation piece.", why: "One-take recording builds performance confidence. In a live setting, you can't stop and restart. Learning to recover from mistakes and keep the groove going is a critical skill — and often the mistakes become the most interesting moments." }
      ],
