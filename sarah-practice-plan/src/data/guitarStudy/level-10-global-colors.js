...
export const level10 = {
  ...
  exercises: [
...

    {
      ...
      levelUp: "Play a 2-note Afrobeat ostinato for 3 minutes without any variation, drift, or embellishment. Every repetition should be indistinguishable from the last."
    },
    {
      id: "gs-10-2",
      time: 8,
    ...
    },
    {
      ...
      tracks: [{ name: "Afrobeat 100", src: "/afrobeat-100.mp3" }],
      recorder: true,
      levelUp: "Play an arpeggiated highlife-style guitar part over the Afrobeat backing track for 3 minutes with warm tone, consistent accent pattern, and behind-the-beat feel."
    },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Find YOUR park position: slowly rock the wah while sustaining a single note. Stop when the tone sounds most pleasing to your ear. Mark that position with tape if needed. This is your personal 'park' — the frequency that flatters your guitar and your style.", why: "Every guitar and every player has a sweet spot where the parked wah sounds best. Speer found his through hours of experimentation. Your sweet spot depends on your guitar's pickups, your amp, and your personal taste. Finding it is an act of self-discovery." },
...

    {
      ...
      steps: [
        ...
        { text: "Apply the melody-as-vocalist concept: sing a short melody in your head (anything — a Khruangbin phrase, a lullaby, a random hum). Now play that melody on the guitar. Let the melody guide your fingers, not the fretboard positions. If you can sing it, you can play it.", why: "Guerrero's approach treats the guitar like a voice. He doesn't think in scale shapes — he thinks in melodies. By singing first and then playing, you bypass the muscle-memory patterns that lock most guitarists into familiar licks. The melody comes from your inner ear, not your fingers." },
...

    {
      ...
      steps: [
        ...
        { text: "Full performance: 5 minutes of free style-switching over the backing track. Move between any global style when the music tells you to — not on a timer, not on a plan. Trust your instincts about when to shift. Record it.", why: "Free-form style-switching is the ultimate global fusion skill. When you can move between Afrobeat, bossa, cumbia, Khruangbin space, and Guerrero melody without thinking, these styles are truly in your blood — they're not exercises anymore, they're colors on your palette." }
      ],
      feel: "This should feel like a world tour in 5 minutes — each style has a different physical sensation. Afrobeat is mechanical, bossa is lilting, cumbia is punchy, Khruangbin is spacious, Guerrero is intimate. The transitions should feel like changing lanes, not hitting walls.",
