  ...
  exercises: [
    {
      ...
      steps: [
        ...
        { text: "Don't stop. Even if you run out of things to describe, keep singing. Follow a thought, follow a breath, follow where the body wants to go. The words will come from the same place the melodies do — not from thinking, but from being present.", why: "Improvised lyrics train the instant connection between thought and voice. The filter disappears. What remains is authenticity." },
        { text: "If you get stuck, repeat a phrase and change one word each time. 'The water's warm today / the water's gone today / the summer's gone today.' Feel how each word change shifts something in the body — 'warm' opens the chest, 'gone' closes it.", why: "Repetition with variation is a legitimate songwriting technique. Many great choruses are built exactly this way." },
      ...
      wrong: "If you're stopping to think between lines, you're not improvising — you're composing slowly. Keep the flow going even if the words are nonsense. Flow first, quality later. If this feels uncomfortable, that's the growth zone — it means you're pushing past the safety of planning into genuine creation.",
...

    {
      ...
      steps: [
        ...
        { text: "Mental set (1 min): three slow, deep breaths. On each exhale, feel the body soften — shoulders drop, belly releases, jaw unclenches. Then set an intention: not 'play perfectly' but 'I'm sharing something real.' The intention lives in the body, not the head.", why: "Intention-setting reframes performance from evaluation to expression. Sports psychology research: athletes who set process intentions ('stay relaxed, have fun') outperform those who set outcome intentions ('don't mess up')." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Play the song again. This time, keep attention in the body: 'breathe into the phrase,' 'feel the right hand relax,' 'let the downbeat land in the foot,' 'feel the lyric in the chest.' When an evaluative thought arises ('that note was flat'), notice it — it pulls attention to the head — and redirect back to the body.", why: "Process focus keeps attention on what you're doing NOW, not on what just happened. Evaluative thoughts pull you into the past — and the past can't be changed mid-performance." },
...

    {
      ...
      steps: [
        ...
        { text: "Session 3 — Flow zone: play moderately challenging material at your sweet tempo (85-100 BPM) for 3 minutes. Notice the body: engaged but not tense, breath moving naturally, vibration traveling freely, the hands and voice running their cycles without effort. Time passing quickly. The body is fully alive and fully at ease simultaneously. That's flow.", why: "Flow requires roughly 4% challenge above current skill level. You're stretching but not breaking. This is where the deepest learning and the best performances happen." },
...

    {
      ...
      steps: [
        ...
        { text: "Start with your most confident song. Let the body settle into it — the familiar fingerings, the melody you've sung a hundred times. Feel the nervousness transform into energy as the music takes over. Play it all the way through.", why: "Starting with strength builds momentum. Professional performers always open with a safe bet." },
        ...
        { text: "During the song, look up at your listener at least twice. Not for approval — to share. Feel the difference in the body: playing with eyes down is a private act; looking up opens the chest, the resonance projects outward, and the music becomes a gift rather than a test.", why: "Eye contact transforms the dynamic from audition (being judged) to connection (sharing something)." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Trade fours: play a 4-bar guitar phrase, then sing a 4-bar vocal response. Feel the music shift between two body locations — hands to voice, fingers to chest — like a conversation between two parts of yourself.", why: "Trading fours forces you to listen to what you just played and respond vocally." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Play all your songs. Let the music flow through the body without monitoring — the hear-feel-choose cycle is invisible now, running every note through your whole being before it becomes sound. Transitions between songs. Dynamic arcs within songs. Eye contact with your audience. If you make a mistake, the body keeps going.", why: "Playing through mistakes is the most important performance skill. The audience doesn't know what you planned — they only know what you played." },
        { text: "After the last song, stop. Let the last note fade in the body. Breathe. Feel the stillness. You just performed a set of original music — songs that passed through your body and became sound. Thank your audience. Stop the recording.", why: "The ending matters. A clean ending with a moment of stillness is more powerful than trailing off." }
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "One sentence: 'I am a singer-songwriter who ______.' Fill in the blank. Say it out loud. Feel the words land in the body. You don't do embodiment anymore. You ARE embodied. Every note passes through your whole being before it becomes sound. That's not a technique — that's who you are.", why: "Declaring your identity makes it real. You're not becoming a singer-songwriter — you are one." }
      ],
