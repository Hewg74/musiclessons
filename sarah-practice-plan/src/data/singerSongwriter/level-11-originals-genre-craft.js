  ...
  exercises: [
    {
      ...
      type: "song",
      what: "Create an original reggae piece using the B-F#-E progression — the same three chords from 'Gimme Love' (The Elovaters) and 'Jah Werx' (Susto), two of your most-played reggae tracks. Offbeat chop at 85 BPM, pentatonic melody in your porch register. Three chords, infinite groove. The rhythm IS the song.",
      ...
      feel: "Reggae should feel like hammock music — swaying, warm, no urgency. If you're relaxed and slightly smiling while playing, the vibe is right. The B-F#-E progression should feel like coming home to your most-played songs.",
      ...
      sarah: "Gene, B-F#-E is the progression running through your reggae DNA — Gimme Love, Jah Werx, and a dozen other tracks in your rotation. Three chords, one groove, your voice on top. This original should feel like joining a conversation you've been listening to for years.",
      metronome: 85,
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Apply the strum to C#m (barre fret 4) → B (barre fret 2) → F# (barre fret 2, E-shape). This is i-bVII-IV in C# minor — the F# is MAJOR, not F#m. That borrowed major IV is why Sol Del Sur sounds simultaneously dark and open, neither sad nor happy.", why: "The major IV chord borrowed from the parallel major key creates Mixolydian ambiguity — the defining harmonic color of modern surf. It's why this progression sounds like the ocean at golden hour." },
      ...
      sarah: "Gene, Sol Del Sur is your #4 most-played song of the year. C#m-B-F# with that syncopated strum IS your surf DNA. Sun Room's secret: Jazzmaster + Tubescreamer always on at low gain + spring reverb. Simple gear, simple chords, incredible feel. Your original should capture that same golden simplicity. One more thing — the F# being major instead of minor is the whole magic. It's borrowed from C# major, creating a sound that's neither happy nor sad. That ambiguity is the surf-psych sound.",
      metronome: 100,
