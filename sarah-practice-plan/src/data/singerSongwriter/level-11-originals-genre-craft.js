  ...
  exercises: [
    {
      ...
      wrong: "If your reggae sounds rushed or aggressive, slow down your delivery. Reggae lives in the space between beats. If the barre chords are too hard, temporarily use capo 4 and play G-D-C shapes — same sound, easier grip. If your lyrics feel forced, switch to humming — the melody matters more than words at this stage. Always end on something that worked — a phrase that felt right, a groove moment that clicked. Your brain encodes the ending and applies it to the whole session.",
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Improvise pentatonic vocals over the riff. Sing in your lower range (E3-B3) — feel the vibration sitting deep behind the sternum, almost subterranean. Raw, unpolished, conversational. Each note should rumble in the center of the chest like it's emerging from the earth. Desert blues is the most embodied vocal style — the body IS the instrument, unmediated by technique.", why: "Desert blues vocals are the most direct vocal style — the resonance sits in the deepest chest addresses, vibrating the breastbone. No decoration, no tricks. The embodiment cycle slows to match the genre: hear the drone, feel it settle in the chest, choose raw honesty over polish, produce the sound from the body's core (Zamorano 2025)." },
