  ...
  exercises: [
    {
      ...
      type: "song",
      what: "Create an original reggae piece using the B-F#-E progression — the same three chords from 'Jah Werx' (Susto), one of your most-played reggae tracks. Offbeat chop at 85 BPM, pentatonic melody in your porch register. Three chords, infinite groove. The rhythm IS the song. (Fun fact: 'Gimme Love' by The Elovaters uses the same I-V-IV shape in a different key — F-C-G.)",
