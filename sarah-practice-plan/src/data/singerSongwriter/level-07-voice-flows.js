...
export const level7 = {
  ...
  exercises: [
...

    {
      ...
      sarah: "Gene, this is what every exercise has been building toward. Your voice and guitar as one instrument. All the individual skills fused into flow. The hear-feel-choose cycle is no longer something you do — it's something you ARE. Let it happen. Once Am-C-G-Em feels automatic, tap 'Draw new progression' below. Full-integration flow shouldn't be progression-specific — prove it on a minor descent, a cyclic minor, a rock minor. Same flow, new harmony.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
    ...
    },
    {
      ...
      sarah: "Gene, G-C-D is Sun Room, Babe Rainbow, Surf Hat — your Australian surf-garage playlist in three chords. This is where the bright golden-hour energy lives. Tap 'Draw new progression' below for weekly variety — a pop axis, a folk I-V-IV-V, a country I-V-V-I. Same major-key flow skill, different flavors. Sun Room doesn't write every song with the same three chords; neither should you.",
      chordProgression: {
        key: "G",
        scale: "major",
        pool: ["three_chord_major", "pop_axis", "folk_i_v_iv_v", "country_i_v_v_i"],
      },
      metronome: 85,
    ...
    },
    {
      ...
      sarah: "Gene, Khruangbin and Skinshape live here — soul groove with understated vocals that serve the groove. This is your 'cool' vocal mode. Tap 'Draw new progression' below — soul groove isn't locked to Am-Dm-G-C. Try a Skinshape-style jazz minor ii-V, a dorian i-IV, a minor-cyclic. Same pocket, same warmth, new harmony. Laura Lee does this constantly.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
        pool: ["jazz_minor_ii_v", "minor_cyclic", "minor_three", "rock_minor"],
      },
      metronome: 90,
      referencePitches: getPitchRange("D3", "A4"),
      pitchContour: true,
...

    {
      ...
      wrong: "If you're singing before hearing the note internally, you're reacting, not audiating. Slow down further. The internal hearing must come FIRST. Play nothing you didn't hear first. Each rep sharpens your prediction model — the prediction error IS the learning signal, so don't avoid it, notice it.",
...

    {
      ...
      steps: [
        { text: "Clap a simple 2-bar rhythm — maybe 'clap clap... clap-clap clap.' Feel the rhythm in your hands and shoulders. Then immediately sing it back on the note A — feel the rhythm migrate from your hands to your chest as the vibration settles behind the sternum: 'dah dah... dah-dah dah.' Match it exactly.", why: "Translating rhythm from hands to voice trains rhythmic audiation — hearing rhythm internally and reproducing it through a different output. This is the same skill used in melodic transcription." },
    ...
    },
    {
      ...
      sarah: "Gene, this is why Khruangbin songs feel so spacious — they sit on one chord forever. And why punk feels urgent — chords fly by. You get to choose where your songs live on that spectrum. Tap 'Draw new progression' below to test the same rhythm-density lesson on different harmonies. A one-chord reggae vamp invites the slow version naturally. A jazz ii-V-I demands the urgent version. Let the progression teach you its native rhythm.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
        pool: ["minor_three", "minor_descent", "minor_cyclic", "desert_vamp"],
      },
      metronome: 80,
      recorder: true
    },
