  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Lock into the soul groove: shorter phrases, rhythmically precise, warm chest resonance. Before each phrase, audiate its melodic contour — does it rise, fall, or hover? Hear the shape before your voice traces it. Soul demands rhythmic awareness AND melodic intention.", why: "Soul singing is defined by rhythmic precision and warm tone. Pre-hearing the melodic contour means every phrase is chosen, not accidental. It sits in the middle of your dynamic range — not whispering, not projecting, just grooving with intention." },
        { text: "Apply emotional color: Am is warm and melancholic, Dm is darker and more tense (the F creates a pull), G is bright and resolved, C is settled and open. Let each chord shift your delivery. Mid-pass check: are you still hearing each phrase before it arrives, or has autopilot kicked in? Both are valid in a flow exercise — but noticing which mode you're in builds awareness.", why: "Soul music is emotionally nuanced — subtle shifts in warmth and intensity with each chord change. The autopilot check is a diagnostic, not a correction: in flow exercises, some autopilot is natural. The skill is knowing when your ear is leading and when your muscle memory is. This is emotional color + chord navigation working together at full integration." },
...

    {
      ...
      feel: "This exercise should feel meditative and deliberate — the opposite of the free-flowing exercises. You're training the 'inner ear' that guides all future improvisation. The silence before each phrase is not empty — it's where the music is being composed.",
...

    {
      ...
      feel: "This should feel like the meditative core of your practice — quiet, internal, focused. The singing is just the external proof of rich internal musical activity. The silence before each phrase is not empty — it's where the music lives first.",
