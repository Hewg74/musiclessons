...
export const level5 = {
  ...
  exercises: [
...

    {
      ...
      steps: [
        { text: "Before you sing B, HEAR it in your head. Play B on the guitar (2nd fret, A string). Listen. Close your eyes and imagine the sound. Can you hear it internally? Now sing it. This is audiation — Gordon's research shows that hearing a note mentally before producing it is the single most important skill for accurate pitch.", why: "Audiation (mental hearing) is the foundation of all ear training. When you can hear a note internally before singing it, your vocal muscles have a target to aim for. Without audiation, you're guessing. With it, you're navigating." },
    ...
    },
    {
      ...
      setup: "Guitar. Drone on A. Metronome at 75 BPM.",
      steps: [
        { text: "Audiation check: play F on the guitar (1st fret, high E string). Listen carefully. Now close your eyes and hear F in your mind without playing it. Can you recall the sound? Now sing it. The more clearly you can hear a note before producing it, the more accurately you'll sing it.", why: "Audiation becomes even more critical with tension notes. B and F are the notes most likely to drift out of tune because they sit a half step from stable tones. If you can hear them internally first, your voice has a precise target." },
...

    {
      ...
      steps: [
        ...
        { text: "Quick-fire round: someone calls a note name, you audiate it, then jump from A instantly. 2 minutes. Record it. Listen back: are you landing ON the note or sliding into it? Clean landings mean your audiation is working. Slides mean you're searching — spend more time hearing the note internally before producing it.", why: "Self-assessment on clean vs. sliding landings is the most precise way to measure your audiation accuracy. Clean = you heard it before you sang it. Slide = you were adjusting in real time. Both improve with practice, but knowing which you're doing tells you where to focus." }
      ],
    ...
    },
    {
      ...
      steps: [
        { text: "2 minutes over the Am drone: sing only leaps. A→D→F→C→G→B→E. Skip at least one note between each pitch. No A-B, no C-D, no E-F. Only jumps. Your voice will constantly cross the passaggio (A3-B3 zone) — let it. Wide leaps mean register shifts. Don't try to keep everything in chest voice. Let the voice flip, crack, shift registers. The cracks become smooth with practice.", why: "Banning stepwise motion forces your ear AND your voice into unfamiliar territory. Wide leaps cross register boundaries that stepwise motion avoids. Learning to navigate these crossings is essential for expressive singing — every great vocalist uses register shifts as a tool, not a flaw." },
        { text: "2 minutes over the drums: same rule (leaps only) but now with rhythm. Breathe from your belly before each leap — wide intervals need more air support than steps. The angular intervals over a groove create a completely different kind of melody — think modern jazz vocals or avant-garde pop.", why: "Angular melodies over a groove require both ear accuracy AND breath management. Wide leaps consume more air than steps. If you run out of breath mid-phrase, you're not supporting from the diaphragm. Take a belly breath before each phrase, not a shallow chest breath." },
    ...
    },
    {
      ...
      steps: [
        { text: "Draw two notes. Before singing, AUDIATE both: see the first note name, hear it in your head. See the second, hear it internally. THEN sing the first for 2 beats, jump to the second for 2 beats. The pause to audiate may feel slow — that's fine. Accuracy over speed. Draw again. 2 minutes.", why: "Audiation under pressure (random notes, no preparation) is the highest-level ear training. A 2019 PMC study found that deliberate, labeled interval practice with feedback is what actually builds expert-level discrimination — not just exposure. The audiation pause IS the deliberate practice." },
...

    {
      ...
      steps: [
        { text: "Silent scale: hear the full A natural minor scale in your head WITHOUT singing. A-B-C-D-E-F-G-A. Can you hear each note distinctly? Can you hear the half steps (B-C, E-F) tighten? If any note is fuzzy, play it on guitar, listen, then try the silent scale again. This is pure audiation.", why: "Gordon's Music Learning Theory places audiation — the ability to hear music internally — as the foundational skill beneath all others. A singer who can audiate accurately before producing sound will always be more in tune, more expressive, and more confident than one who can't." },
        { text: "Silent jump: hear A in your head. Now hear F (minor 6th — bittersweet). Can you feel the emotional character of the jump WITHOUT singing? Now audiate A→C# (major 3rd — bright). Different feeling, same silence. The emotion exists in your imagination before it exists in sound.", why: "Audiating intervals (not just individual notes) is the advanced form of mental hearing. When you can feel the emotional quality of a jump in your mind's ear, you can compose melodies internally — which is how professional songwriters work." },
        { text: "Now sing: audiate A-F internally, then produce it. Audiate A-C# internally, then produce it. Compare: did the sung version match what you heard internally? If yes, your audiation is accurate. If the sung version was higher or lower than what you imagined, your internal reference needs calibration — play the notes on guitar and re-audiate.", why: "The gap between what you audiate and what you produce is your calibration error. Closing this gap is the entire goal of ear training. When audiated pitch = produced pitch consistently, you have professional-grade internal hearing." },
        { text: "Body scan: sing a low note (A3). Notice where you feel it physically — chest, throat, belly? Now sing a high note (G4). Where does that live — head, sinuses, behind the eyes? Now jump A3→G4 and feel the resonance SHIFT. Your passaggio (around A3-B3) is the transition zone where chest resonance hands off to head resonance. Both registers are you. The shift is natural.", why: "Vocal production awareness means knowing WHERE in your body each note lives. Chest voice (below passaggio) resonates in the ribcage. Head voice (above) resonates in the sinuses and skull. The passaggio zone is where they overlap. Understanding this physically — not just theoretically — prevents strain and enables the full range." },
        { text: "Integrated practice: audiate a random jump (pick two notes in your head). Feel where each note will resonate in your body. Take a belly breath. Now produce the jump. Rate yourself: (1) Did the pitch match your audiation? (2) Did the resonance feel smooth or strained? (3) Did the emotional intent come through? Repeat 10 times. Record the last 5.", why: "Integrating audiation + body awareness + emotional intent in a single moment is the capstone skill. Professional singers do this unconsciously — they hear the note, feel where it goes, breathe, and produce with emotional intent, all in a fraction of a second. This exercise makes the process conscious so it can become unconscious with practice." },
      ...
      feel: "This should feel meditative and deeply internal. The silence is as important as the sound. When you can hear music in your imagination as vividly as you hear it in your ears, you've developed the singer's most powerful tool — one that works in every key, every genre, every moment.",
      wrong: "If you can't hear notes internally at all, that's normal for beginners — audiation is a skill that develops gradually. Start by playing a note on guitar, then immediately trying to recall it silently. The memory fades quickly at first but strengthens with practice. Don't skip this exercise because it feels 'too mental' — the mental work is the foundation of everything physical.",
