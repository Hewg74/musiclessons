...
export const level5 = {
  ...
  exercises: [
...

    {
      ...
      wrong: "If B sounds 'wrong' or 'out of tune,' you might be singing Bb (B-flat) instead of B natural. B natural is a whole step above A. Use the drone and pitch display to calibrate. If B doesn't feel different from your pentatonic notes, slow down: research shows dissonant intervals recruit more somatosensory cortex (PMC5608010) — B should feel MORE in the body than A or C. If it doesn't yet, hold B against the drone for 8 slow beats and scan your body for the tension.",
...

    {
      ...
      steps: [
        ...
        { text: "Quick-fire round: someone calls a note name, you audiate it, then jump from A instantly. 2 minutes. Record it. Listen back: are you landing ON the note or sliding into it? Clean landings mean your audiation is working. Slides mean you're searching. Mid-pass check: are you still hearing each landing note before launching, or has autopilot kicked in and you're just reacting to note names? If autopilot kicked in — good, you noticed. Return to hearing first.", why: "Self-assessment on clean vs. sliding landings is the most precise way to measure your audiation accuracy. Clean = you heard it before you sang it. Slide = you were adjusting in real time. The autopilot check is a diagnostic: speed naturally pushes you toward reacting instead of pre-hearing. Catching that shift is the awareness you're building." }
      ],
...

    {
      ...
      sarah: "Gene, this is the exercise that ties every thread together into one unified act. Hearing before singing. Feeling where notes live in your body. Choosing what they express. Producing them. Comparing what came out to what you intended. These aren't five separate skills — they're ONE cycle: hear it, feel it, choose it, sing it, compare. A master singer runs all five simultaneously, automatically. Right now you're making it conscious so it can become unconscious. When this clicks, everything gets easier — every jump, every key change, every emotional arc — because the cycle runs itself and you're simply present with the music.",
      drone: { root: "Am", octave: 2, texture: "pure" },
      referencePitches: getPitchRange("A3", "A4"),
      pianoKeys: { notes: ["A3", "B3", "C4", "D4", "E4", "F4", "G4"], label: "A Natural Minor", range: ["A3", "A4"] },
      pitchContour: true,
