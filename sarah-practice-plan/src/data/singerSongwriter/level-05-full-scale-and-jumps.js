...
export const level5 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      setup: "Guitar. Drone on A. Metronome at 75 BPM.",
      steps: [
        { text: "Audiation check: play F on the guitar (1st fret, high E string). Listen. Close your eyes — hear F forming inside. Now feel WHERE it lives: F sits low and heavy, a darkness that compresses the throat and pulls the resonance downward, like gravity in the chest. When you have both the sound and the body sensation, sing it. The more channels you use to find a note — hearing AND feeling — the more accurately you'll land.", why: "Audiation becomes even more critical with tension notes. B and F are the notes most likely to drift out of tune because they sit a half step from stable tones. Adding body-location awareness gives you a second targeting system (Zamorano 2025: body awareness predicts pitch accuracy, R²=0.41). Tension notes recruit more somatosensory cortex (PMC5608010) — F should feel HEAVIER in the body than E or G." },
        { text: "Sing E, then step up to F. Feel the shift: E is open and bright, the resonance floating in the upper chest. F arrives like a shadow — the vibration compresses, darkens, pulls downward. Alternate E-F-E-F slowly. Each time, feel the body toggle: light (E) to heavy (F) to light (E). The half step is tiny in pitch but enormous in body sensation.", why: "E-F is the second semitone in A natural minor. Where B-C pulls upward (yearning in the throat), E-F pulls downward (gravity in the chest). These two half steps are the emotional engine of the minor scale — and each has a distinct body direction. The body mirrors the harmonic character." },
