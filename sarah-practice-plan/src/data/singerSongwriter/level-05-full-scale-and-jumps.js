  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Build a mood arc using only jumps: Start dark (F-based jumps, wide intervals). Gradually shift to more open (E-based, D-based). End intimate (B-based, small steps). Before each jump, hear the emotional destination — feel the darkness, the openness, the intimacy — before your voice produces it. The emotional journey lives in the interval choices. 2 minutes, record.", why: "An emotional arc built from interval choices is a melody in its purest form — stripped of rhythm, lyrics, and harmony. Pre-hearing the emotion (not just the pitch) is advanced audiation: you're audiating feeling, not frequency. Aarhus (2021) found that imagery + production = equal learning in one-third the time." },
