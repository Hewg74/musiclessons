...
export const level1 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      title: "Drone Singing",
      type: "vocal",
      drone: { root: "G", octave: 3, texture: "analog" },
      ...
      steps: [
        ...
        { text: "While strumming, hum the note G. Match it to the open G string. Hold it — one continuous, sustained hum over the strumming.", why: "One note is the absolute minimum vocal demand. If the strum breaks even with a single sustained hum, the autopilot foundation needs more work." },
