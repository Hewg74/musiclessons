  ...
  exercises: [
    {
      ...
      steps: [
        ...
        { text: "Set each observation to a simple melody over your chord progression. Let the natural stress of the words guide the rhythm — feel how each word wants to land on a beat or float between beats. The mouth shapes the vowels, and the melody follows what the body already knows.", why: "Prosody — matching word stress to melodic stress — happens naturally when you speak the words musically. Don't force it." },
    ...
    },
    {
      ...
      steps: [
        { text: "Write one line for each sense: 'I see the palms bending / I hear the trade winds pushing / I smell the salt coming in / I feel the warm tile under my feet / I taste the mango on my tongue.' Each sense activates a different part of your body as you write — feel it happening.", why: "Explicitly writing for each sense forces you past visual-only description. Most lyrics over-rely on sight. Sound, smell, touch, and taste create deeper immersion." },
        { text: "Now remove the 'I see / I hear' frames. Just the images: 'Palms bending / trade winds pushing / salt coming in / warm tile underfoot / mango on the tongue.' Speak them aloud. Notice how each image opens a different physical channel — the mouth shapes differently around 'salt' than 'mango,' and the body knows the difference.", why: "Removing the 'I' frames makes lyrics more immediate and universal. The listener enters the scene instead of watching you describe it." },
...

    {
      ...
      steps: [
        { text: "Sing through your verse. Count how many syllables you're singing per bar. A line like 'I was driving down the highway when the sun started going down' packs 16 syllables into 2 bars — that's high density, storytelling mode. Feel how the mouth stays busy, the breath short, the body leaning forward.", why: "Density is a compositional tool most songwriters use unconsciously. Making it conscious lets you control pacing and emotional weight deliberately." },
...

    {
      ...
      steps: [
        { text: "Pick a word from one of your lyrics: say, 'water.' Speak it aloud — feel how 'water' opens the mouth wide on 'wah' then closes on 'ter.' Find perfect rhymes: daughter, quarter. Then near-rhymes: wander, farther, harbor. Then assonance: fallen, bottle, copper. Each rhyme type creates a different physical echo in the mouth.", why: "Near-rhymes sound fresh because they satisfy the ear partially. The listener feels the echo without predicting the exact word." },
...

    {
      ...
      steps: [
        ...
        { text: "Now sing the line over your chord progression. Do the stressed syllables land on strong beats (1 and 3) and high notes? When stress and beat align, the body produces them as one act — the emphasis, the pitch, and the breath all converge. If so, the prosody is good.", why: "When stress and beat align, lyrics sound effortless. When they clash, the listener feels something's 'off' even if they can't say why." },
...

    {
      ...
      steps: [
        { text: "Write out all your lyrics. Read them without the music. Cross out any word you could remove without losing meaning. Each cut creates space — and space is where the body breathes between phrases.", why: "Words that serve no purpose dilute the impact of words that do. Every unnecessary word weakens the song." },
