...
export const level8 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      feel: "Free pentatonic improv should feel like surfing — riding the wave of the backing track, making intuitive decisions, sometimes wiping out and paddling back. The flow state lives here. When the hear-feel-choose cycle is running beneath the surface, each note feels chosen even though you didn't consciously choose it — your body reaches for the right resonance position, your ear confirms it, and the note emerges. That's the cycle running automatically. That's flow. You'll know it's happening when you stop thinking about notes and start thinking about feelings.",
