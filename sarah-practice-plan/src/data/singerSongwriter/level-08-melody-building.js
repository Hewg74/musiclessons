  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "All five: A, C, D, E, G. Full pentatonic. Create a melody that uses all five. Then go back to your 2-note melody. Which do you prefer? Both are valid.", why: "Sometimes the 2-note melody is more memorable than the 5-note one. More notes ≠ better music. This exercise proves that. New melodic intervals consolidate during sleep — practice today, test tomorrow, and you'll find the constraint melodies feel more natural after a night's rest." }
      ],
