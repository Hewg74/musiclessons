...
export const level14 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      feel: "Process focus should feel like meditation while playing — present-tense, non-judgmental, attentive. The music actually sounds better because you're not tensing up after every imperfection.",
...

    {
      ...
      feel: "Vertical editing should feel clinical but satisfying — like tuning an engine. Each pass makes the song tighter, more intentional, more polished. The song doesn't change identity; it becomes more itself.",
    ...
    },
    {
      ...
      feel: "Duo singing should feel like a conversation — two voices weaving in and out, sometimes together, sometimes apart. The blend moments should give you chills.",
...

    {
      ...
      feel: "The flow zone session should feel qualitatively different — time distortion, effortless concentration, intrinsic motivation. Once you've felt it, you'll recognize it immediately.",
