...
export const level10 = {
  ...
  unlocks: "Originals & Genre Craft (Level 11)",
  ...
  exercises: [
    ...
    // ─── ENRICHMENT — BORROWED CHORDS, MODAL DEPTH, BASS MOTION ───

    {
      id: "ss-10-16",
      time: 8,
      title: "Borrowed Colors — The Chords From Next Door",
      type: "song",
      drone: { root: "Am", octave: 2, texture: "warm" },
      what: "Am lives in natural minor. But sometimes songs 'borrow' chords from the parallel major — and these visitors add emotional colors that diatonic harmony can't reach. The bVI (F major) feels cinematic, the bVII (G major) feels triumphant, the iv (Dm) feels deeper than IV (D major). Learn to HEAR and FEEL these borrowings as body events — each borrowed chord has a physical signature that arrives before your theory brain names it. Based on Narmour's implication-realization model: expectation violation creates emotional impact, and borrowed chords are the most accessible form of harmonic surprise.",
      setup: "Guitar in standard tuning. Voice check: hum Am for 10 seconds, feel it settle in the belly. You'll be singing melodies over borrowed chord progressions — stay in your comfortable range (E3-A4).",
      steps: [
        { text: "Play Am → F → G → Am slowly (4 beats each). The F major (bVI) is borrowed from A major / the parallel key system. As it lands, feel the warmth arrive — a resonance that doesn't belong in minor but settles into the upper chest like unexpected sunlight. It's not wrong; it's borrowed. Where does F live in your body? Close your eyes and map it.", why: "The bVI chord shares NO notes with the tonic minor chord (Am = A-C-E, F = F-A-C — only A overlaps). This maximum harmonic distance creates maximum emotional impact. Narmour's implication-realization theory predicts that the greater the deviation from expected harmony, the stronger the emotional response. The body registers this as a 'catch' in the chest — surprise warmth (Nummenmaa 2024: unexpected harmonic shifts activate upper-body sensation maps)." },
        { text: "Play Am → G → F → Am. Now feel the bVII (G major) — a lift, brightness borrowed from Mixolydian territory. The resonance opens across the shoulders and pushes toward the forehead. G major in A minor is the 'triumphant departure' chord — it says 'we're going somewhere bigger.' Compare: how does the bVII body signature differ from the bVI?", why: "The bVII is the second most common borrowed chord. It creates lift without the dominant tension of V (E major). The body opens outward rather than leaning forward — it's expansion rather than pull. Allah-Las use bVII constantly in their progressions, and that floating, anthemic quality is exactly this chord's body signature." },
        { text: "Compare Am → Dm (iv, natural minor — the chord that BELONGS) vs Am → D major (IV, borrowed from parallel major). Play each twice. The iv (Dm) settles deep in the belly — familiar, dark, heavy. The IV (D major) lifts the resonance to the chest — brighter, surprising, a shaft of light in a minor key. Feel the difference in your body BEFORE you name it theoretically.", why: "The iv vs IV comparison isolates the borrowed-chord effect to a single note change (F vs F#). When you can feel this one-note difference as a body event — Dm pulling the belly down vs D major lifting the chest up — you've internalized borrowed-chord sensitivity at the somatic level. This is the embodiment cycle running on harmonic color." },
        { text: "Sing a melody over Am-F-G-Am. Let the borrowed chords PULL your melody into new territory — when F arrives, let your voice respond to the warmth (maybe it opens to a wider interval or rises slightly). When G arrives, let it lift you. The borrowed chords are emotional invitations; your melody RSVPs.", why: "Melodic response to harmonic surprise is the mark of an advanced improviser. When the chord changes and your melody REACTS — following the body's response rather than a predetermined scale — you're composing in real time with harmonic awareness. This is Gordon's audiation stage 6: improvisation guided by internal harmonic hearing." },
        { text: "Now build your own borrowed-chord progression. Start with Am, add one or two borrowed chords (bVI, bVII, IV, or even bIII — C major used as a bright landing), and end on Am. Play it, sing over it, feel the emotional arc the borrowed chords create.", why: "Composing with borrowed chords transforms you from someone who plays chords to someone who paints with harmonic color. Each borrowed chord is a new pigment. The progression becomes an emotional palette, not just a chord sequence." },
        { text: "Record a 2-minute improvisation over your borrowed-chord progression. The borrowed chords should sound like 'surprise warmth' — not wrong, just unexpected. Listen back: can you hear the moments where the harmony opens up beyond standard minor?", why: "The recording captures whether the borrowed chords are landing as emotional events or just as 'different chords.' If the warmth, lift, or depth is audible on playback, you've internalized borrowed-chord feeling. If they just sound random, spend more time on steps 1-3 to build the body signatures." },
        { text: "End-of-exercise retrieval: set the guitar down for 60 seconds. Then from silence, audiate Am-F-G-Am — hear all four chords internally, feel each one's body address. Then sing a melody over the audiated progression WITHOUT playing guitar. Can you feel the borrowed chords pulling your melody even when they're only in your inner ear?", why: "Audiating borrowed chords without external sound is the ultimate test. When the bVI's warmth and the bVII's lift exist in your inner ear strongly enough to guide melody, you've internalized harmonic color at the deepest level. This is audiation operating on harmony, not just pitch." }
      ],
      feel: "Each borrowed chord should hit like an unexpected emotion — the bVI arrives as a pang of cinematic warmth in the upper chest, the bVII opens the shoulders with triumphant brightness, the iv deepens the belly's ache beyond what standard minor achieves. Borrowed chords bypass the analytical mind and speak to the body directly. When F major lands in an A minor context, notice: your breath catches slightly, your posture shifts. That physical response IS the chord's meaning. The embodiment cycle registers harmonic surprise as a somatic event before theory names it.",
      wrong: "If the borrowed chords just sound 'wrong' or out of key, you haven't established Am strongly enough as home. Play Am-Dm-Em-Am (all diatonic) four times to anchor the key. THEN introduce the borrowed chord — the contrast is what creates the effect. VOCAL TIP: if your voice tightens on borrowed chords, it's because the body is bracing against the harmonic surprise. Breathe into it — let the chest stay open. The surprise is the point.",
      sarah: "Gene, borrowed chords are the secret sauce of your entire playlist. Hermanos Gutiérrez build whole songs on the bVI. Allah-Las' 'Long Journey' (A-C-G-D) borrows both C (bIII) and G (bVII) from A minor. And that descending progression you hear everywhere in psych-surf — Am-G-F-E — uses bVII and bVI borrowed from natural minor with V pulled from harmonic minor. Sol Del Sur's F# major chord in C#m is borrowed from the parallel major. You've been FEELING these chords your whole listening life. Now you can USE them.",
      metronome: 75,
      referencePitches: getPitchRange("A3", "A4"),
      pianoKeys: { notes: ["A3", "C4", "D4", "E4", "F4", "G4"], label: "Am + Borrowed (F, G)", range: ["A3", "A4"] },
      pitchContour: true,
      recorder: true
    },
    {
      id: "ss-10-17",
      time: 8,
      title: "Modal Colors — Beyond Major and Minor",
      type: "song",
      drone: { root: "Am", octave: 2, texture: "tanpura" },
      what: "Dorian, Mixolydian, and Phrygian — three modes that live in Gene's genre world. Each mode is a complete emotional universe defined by ONE note that differs from the 'standard' scale. Dorian = Skinshape/reggae territory (minor with a bright 6th). Mixolydian = surf-rock/Khruangbin (major with a bluesy 7th). Phrygian = Hermanos Gutiérrez/flamenco (dark, exotic minor with a tense b2). Based on Nummenmaa (2024) body maps: different tonalities activate different body regions cross-culturally — modes aren't just theoretical; they have embodied signatures.",
      setup: "Guitar in standard tuning. Drone on Am for Dorian and Phrygian exercises, drone off for Mixolydian (or switch to G). Voice check: sing A3 for 10 seconds, feel it settle. You'll explore three modes from the same root note to maximize contrast.",
      steps: [
        { text: "Play Am Dorian: A-B-C-D-E-F#-G. The ONLY difference from natural minor is F→F#. Play the scale slowly, and when you reach F#, STOP. Feel it. The raised 6th brightens the upper chest like a window opening in a dim room — the minor darkness remains, but a warm shaft of light enters. Sing the scale. Where does F# live compared to F natural?", why: "Dorian's raised 6th is the single note that transforms standard minor into something sophisticated and groovy. Skinshape's 'I Didn't Know' uses Dorian phrasing — minor chords with that bright F# threading through. The body registers the brightness of F# against the darkness of the minor context as a specific upper-chest warmth (Nummenmaa 2024: timbral/tonal brightness maps to upper-body activation)." },
        { text: "Play A Mixolydian: A-B-C#-D-E-F#-G. It's A major with a lowered 7th (G natural instead of G#). Play the scale and STOP on G natural. Feel: it's major-bright in the mask, but the G pulls the resonance down toward the jaw — a bluesy, rootsy grounding. The brightness of major with a gravity that keeps it from floating away. This is surf-rock territory.", why: "Mixolydian is the sound of Khruangbin's guitar leads, Grateful Dead jams, and every blues-rock riff that sounds 'major but dirty.' The flat 7th adds earthiness to brightness. The body signature is distinctive: major's forward-face resonance with a jaw-level anchor. That combination IS the surf-rock sound." },
        { text: "Play A Phrygian: A-Bb-C-D-E-F-G. The b2 (Bb) creates instant tension — as you sing it, feel the resonance compress into the throat and jaw, dark and ancient. This is the most physically intense mode: the half-step A→Bb creates a gravity that pulls the entire body forward and downward. Hermanos Gutiérrez and Tinariwen live here.", why: "Phrygian's b2 is the most emotionally charged interval in any mode. The half-step above the root creates a 'falling into' sensation — the body leans forward, the throat tightens slightly, the emotional register shifts to dark/exotic/ancient. Nummenmaa (2024): dissonant intervals activate throat and jaw regions cross-culturally. The body KNOWS Phrygian is dark before the theory brain names it." },
        { text: "Improvise 1 minute in each mode over the Am drone. Dorian first: emphasize F# — let the brightness thread through minor darkness. Then Mixolydian: emphasize G natural over an A chord — let the bluesy pull ground the brightness. Then Phrygian: emphasize Bb — let the darkness deepen. Feel how each mode has its own body geography and emotional temperature.", why: "One minute per mode with conscious attention to the distinguishing note is the fastest path to modal internalization. The body maps each mode to a distinct physical signature: Dorian = upper-chest warmth, Mixolydian = jaw-anchored brightness, Phrygian = throat-compressed darkness. Three modes, three body addresses, three emotional worlds." },
        { text: "Switch modes mid-phrase: 2 bars of Dorian, then pivot to Mixolydian for 2 bars. Feel the color shift in your body as you cross the boundary — the upper-chest warmth of Dorian brightens and lifts to the mask of Mixolydian. Then Mixolydian to Phrygian: the brightness compresses and darkens. These pivots are chromatic color changes.", why: "Modal pivots within a single phrase are how advanced improvisers create emotional complexity. Each pivot is a body migration — the resonance physically moves as the mode shifts. When you can feel the pivot in your body before your theory brain processes the note change, you're operating at an intuitive modal level." },
        { text: "Pick the mode that feels most 'you.' Write a 4-bar melody in that mode. Record it. Then write the same melody's emotional opposite in a contrasting mode. Record that too. Two melodies, two modes, two emotional worlds — same root note.", why: "Choosing your 'home mode' and composing in it integrates modal theory into your compositional identity. Most artists unconsciously favor one mode — Skinshape favors Dorian, Khruangbin favors Mixolydian, Hermanos Gutiérrez favors Phrygian. Knowing YOUR mode is knowing your harmonic personality." },
        { text: "End-of-exercise retrieval: guitar down, eyes closed. Audiate each mode from A — hear Dorian's bright F#, Mixolydian's bluesy G, Phrygian's dark Bb. Can you feel each mode's body signature without external sound? Sing each mode's distinguishing note from memory.", why: "Audiating modal colors without the instrument proves internalization. When F# creates upper-chest warmth in your inner ear, when Bb compresses the throat in audiation alone — the modes live in your body, not just on the fretboard." }
      ],
      feel: "Each mode should feel like a different season in the same landscape. Dorian is autumn: warmth settling into the chest with a gentle ache, the bright 6th like late-afternoon sun. Mixolydian is late summer: brightness filling the mask with a grounding pull in the jaw, lazy and bluesy. Phrygian is deep winter night: dark, compressed, ancient, the resonance pulling downward into the throat. When you can feel the season change as you switch modes, the hear-feel-choose cycle is operating on modal color. The modes are not theoretical abstractions — they are body states.",
      wrong: "If all three modes sound the same as natural minor, you're not emphasizing the distinguishing note enough. In Dorian, play F# on EVERY beat for 4 bars — make it impossible to miss. Same for Mixolydian's G natural and Phrygian's Bb. The mode IS the one note that differs. VOCAL TIP: if Phrygian's Bb feels vocally uncomfortable (tight throat), that tightness IS the mode's body signature. Don't fight it — lean into the compression. Dark modes feel physically dark.",
      sarah: "Gene, these three modes map directly onto your playlist. Skinshape and reggae = Dorian. Khruangbin and surf-rock = Mixolydian. Hermanos Gutiérrez and desert blues = Phrygian. You've been hearing these modes your whole life — now you can play and sing in them intentionally. Try this: take your Am progression and play it three times — once emphasizing F# (Dorian), once emphasizing G natural over A major (Mixolydian), once emphasizing Bb (Phrygian). Same root, three completely different songs.",
      metronome: 75,
      fretboard: { scale: "a-dorian", position: 1 },
      referencePitches: getPitchRange("A3", "A4"),
      pianoKeys: { notes: ["A3", "Bb3", "B3", "C4", "C#4", "D4", "E4", "F4", "F#4", "G4"], label: "A: Dorian (F#) / Mixolydian (C#,G) / Phrygian (Bb)", range: ["A3", "A4"] },
      pitchContour: true,
      recorder: true
    },
    {
      id: "ss-10-18",
      time: 8,
      title: "Bass Motion — Feel the Foundation Move",
      type: "vocal",
      drone: { mode: "cycle", progression: ["Am", "G", "F", "Em"], bpm: 70, stepDuration: "2m" },
      what: "Bass lines imply harmony. When the bass moves stepwise (A→G→F→E), it creates a feeling of inevitable descent — the ground moving under your feet. When it leaps (A→F), it creates surprise. Bass motion is the skeleton of every chord progression, and learning to HEAR it transforms how you understand harmony. You've been singing melodies on TOP of harmony; now learn to hear the BOTTOM — the bass foundation that holds everything up.",
      setup: "Guitar in standard tuning. Voice check: sing A2 or A3 (whichever is comfortable) for 10 seconds. Feel it rumble in the lowest part of the chest. This exercise works in your low register — if A2 is too low, transpose up an octave.",
      steps: [
        { text: "Play bass notes A→G→F→E (one per bar, descending stepwise) on the low E and A strings. Sing each bass note in your lowest comfortable register. Feel how the ground MOVES underneath you — each step down pulls the resonance deeper into the belly, like descending stairs in the dark. The inevitability of stepwise descent is a physical sensation: gravity pulling the body's resonance center downward.", why: "Descending stepwise bass motion (A-G-F-E, or the 'Andalusian cadence') is one of the most powerful harmonic patterns in Western music. The body registers stepwise descent as gravitational pull — each note feels inevitable, like the next step must happen. This is Narmour's implication-realization: stepwise motion implies continuation, and the body leans into the expectation (PMC5608010)." },
        { text: "Now play bass A→F→G→A (leap down, step up, step up). Sing each note. Feel the SURPRISE of the leap — A to F skips over G, and the body registers that gap as a lurch in the belly. Then the stepwise return (F→G→A) feels like settling back, each step restoring ground. Map the difference: leaps create surprise, steps create inevitability.", why: "Leaping bass motion violates the stepwise expectation, creating a physical jolt. The body's response to a bass leap is more visceral than to a melody leap because bass frequencies activate the lower body and torso more directly (Nummenmaa 2024: low-frequency sound maps to lower-body sensation). Contrasting leaps with steps gives you two bass-motion colors: surprise and inevitability." },
        { text: "Play just the bass notes A→G→F→E and AUDIATE the implied chords — what harmony does each bass note suggest? A implies Am. G implies G major (or Em/G). F implies F major (or Dm/F). E implies Em (or E major for harmonic minor resolution). Sing the bass, then sing the chord's 3rd on top. Can you hear the full chord from just the bass?", why: "Audiating implied chords from bass notes is advanced harmonic hearing. The bass note is the strongest cue for chord identity — professional musicians identify chord progressions by tracking the bass first. When you can hear the whole chord suggested by a single bass note, you're hearing harmony from the foundation up." },
        { text: "Sing the bass line yourself (A-G-F-E, low register) while strumming the chords above (Am-G-F-Em). Your voice is the bass, your guitar is the harmony — two layers from one person. Then switch: strum only the bass notes on the low strings, sing a melody in your normal range on top. Dual-task both directions.", why: "This dual-task exercise separates bass awareness from melody awareness, then recombines them. Singing bass while strumming chords forces the ear to track two harmonic layers simultaneously — exactly what arrangers, producers, and bass players do instinctively. The body splits its resonance: low belly for the bass voice, chest/mask for the melody." },
        { text: "Create your own bass line for Am-C-G-Em: instead of all roots (A-C-G-E), try A-B-C-D — a stepwise ASCENDING bass under a progression that normally descends. Feel how the ascending bass creates forward momentum that counteracts the chord changes. Or try A-G-E-B — all leaps, maximum surprise.", why: "Creative bass lines transform standard progressions. When the bass moves independently of the chord roots, the harmony acquires depth and sophistication. This is what distinguishes Khruangbin's bass lines from standard guitar strumming — Laura Lee's bass is a counter-melody, not just root notes." },
        { text: "2-minute freestyle: sing melodies over the descending bass drone (A-G-F-E cycling). Let the bass motion CARRY your melody — when the bass descends, does your melody follow or oppose? When the bass reaches the bottom (E), does your melody resolve or keep moving? Record the freestyle.", why: "Singing over bass motion with conscious awareness completes the harmonic picture: you now hear melody (top), chords (middle), and bass (bottom) as three layers of a single harmonic event. The body experiences all three layers simultaneously — melody in the mask, chords in the chest, bass in the belly. This is full-spectrum harmonic embodiment." },
        { text: "End-of-exercise retrieval: guitar down. Audiate the descending bass A-G-F-E in your inner ear. Feel each note's body address descend — belly, lower belly, pelvic floor, sitting bones. Then audiate a melody floating above it. Can you hold both layers in audiation simultaneously?", why: "Dual-layer audiation (bass + melody) is the pinnacle of harmonic inner hearing. When you can sustain two independent musical lines in your mind's ear, you've developed the kind of harmonic audiation that Gordon describes as the highest stage of music learning. This is the skill that makes arranging, producing, and band musicianship intuitive." }
      ],
      feel: "Bass motion should feel like the ground itself is moving — each note changes the foundation under your feet. Descending stepwise bass pulls the body's resonance center downward through the belly and into the pelvis, creating a sense of inevitable gravity. Ascending bass pushes upward through the chest, creating lift and forward momentum. Leaping bass creates lurches and surprises in the torso. When you can feel the bass as a physical journey through the lower body while your melody floats above in the chest and mask, you're experiencing harmony as a full-body, multi-layered event.",
      wrong: "If singing bass notes feels uncomfortable or strained, transpose up an octave — the point is hearing bass MOTION, not straining your range. A2 is low for most tenors; A3 works fine for understanding descending stepwise patterns. VOCAL TIP: if you can't hold the bass note steady while hearing chords above, simplify: just sing the bass line alone, no guitar. Build the dual-task gradually — bass alone, then bass + single chord strum, then bass + full strumming.",
      sarah: "Gene, bass motion is the hidden architecture of every song you love. That Am-G-F-E descending line is the backbone of 'Stairway to Heaven,' 'Hotel California,' and about a thousand reggae songs. Khruangbin's magic comes from Laura Lee's bass — she doesn't just play roots, she plays counter-melodies that move stepwise underneath the guitar. When you hear bass motion, you hear the song's skeleton. And your own bass voice — that low porch-register rumble — is perfect for singing bass lines while strumming. Dual-voice Gene: bass and melody from one person.",
      metronome: 70,
      referencePitches: getPitchRange("A2", "A4"),
      pianoKeys: { notes: ["A2", "E3", "F3", "G3", "A3"], label: "Bass Motion: A-G-F-E", range: ["A2", "A3"] },
      pitchContour: true,
      recorder: true,
