...
export const level10 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      sarah: "Gene, every song you love has this tension-resolution engine. Now you can feel it while playing. This changes how you write — you'll use tension and resolution intentionally. For a more sophisticated version: Skinshape's 'I Didn't Know' uses Gm-C-A7-Dm — a minor ii-V motion borrowed from jazz. The A7 creates tension that resolves to Dm. This is what makes Skinshape sound 'sophisticated but not jazz.' Replacing triads with 7ths changes the vibe from 'campfire' to 'golden hour studio.'",
      metronome: 80,
      referencePitches: getPitchRange("G3", "D4"),
    ...
    },
    {
      ...
      sarah: "Gene, borrowed chords are the secret sauce of your favorite artists. Hermanos Gutiérrez's entire sound is built on bVI. Allah-Las use bVII constantly — their 'Long Journey' (A-C-G-D) borrows both the C (bIII) and G (bVII) from A minor to create that floating, modal quality. And that descending minor progression you hear everywhere — Am-G-F-E — uses the bVII (G) and bVI (F) borrowed from natural minor, with the E (V) pulled from harmonic minor for the resolution back to Am. That progression IS the psych-surf sound, and now you know why it works. Here's another borrowed chord masterclass: Sol Del Sur's C#m-B-F# has a secret — the F# is MAJOR, not minor. It's borrowed from the parallel major key (C# major). This creates 'Mixolydian ambiguity' — the progression sounds simultaneously dark and open, neither purely sad nor purely happy. This IS your golden hour surf sound.",
      referencePitches: getPitchRange("G3", "D4"),
