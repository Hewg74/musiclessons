...
export const level9 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        { text: "Seed 1 — MELODY: Close your eyes for 5 seconds. Audiate a short melody fragment — hear it internally before it leaves your mouth. Then hum or sing it (4-8 notes). Record it immediately. Tag it: 'melody seed, [mood word], [date].' Done. Under 30 seconds.", why: "Speed matters more than quality — but audiating the melody first means you're capturing what your inner ear composed, not what your voice happened to produce. Play nothing you didn't hear first. Professional songwriters like Dan Wilson maintain thousands of voice memos. The discipline is CAPTURE, not perfection." },
