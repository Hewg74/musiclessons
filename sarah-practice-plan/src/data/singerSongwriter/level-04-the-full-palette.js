...
export const level4 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        { text: "Strum Am on autopilot with the backing track. Sing pentatonic notes (A-C-D-E-G) using ONLY whole notes — one note per bar. Slow, deliberate, letting each note breathe. Before each note, hear it in your head first — even for a brief moment. Which color do you want next? Hear it, then sing it.", why: "Starting with whole notes forces intentional note choice. When each note lasts a full bar, the selection matters — you're composing in slow motion. The 'hear it first' habit seeds audiation naturally: at this tempo, you have time to pre-hear every note." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Start humming along — no specific notes, no pentatonic thinking. Just match the ENERGY of the track. When it's sparse, hum sparsely. When it fills up, hum more. You're absorbing phrasing patterns through imitation. When you hear a phrase you love in the track, try to hold it internally for a moment before humming it back — the echo method works here too. Catch the phrase while it's fresh, hold it for a beat, then mirror it. That tiny pause between hearing and humming is audiation in action.", why: "Humming along with a reference is how musicians have learned for millennia — before notation, before theory. Your ear absorbs phrasing, timing, and dynamics faster through imitation than through instruction. The echo-and-hold technique bridges absorption and audiation — you're not just parroting, you're briefly holding the phrase internally before reproducing it." },
...
,
...

    {
      ...
      steps: [
        ...
        { text: "The full chain from anchor: drone on A (your anchor). Without playing anything on guitar, try to hear the pentatonic ascending: A (the drone gives you this one for free)... then C (feel the minor 3rd distance from the drone)... then D (one step up from C)... then E (the 5th — you know this one deeply from Level 3)... then G (a minor 3rd above E, or the reach from the root). Sing each note as you hear it internally. Check each one. The drone is your compass, the intervals are your distances, and together they give you a complete map of the palette.", why: "This is the synthesis: hearing the full pentatonic from anchor + intervals alone, with no external reference except the drone. Each note is reached by a known interval — from the root, from the previous note, or from a familiar landmark (like the 5th you mastered in Level 3). This is NOT 'hearing from nothing' — it's 'hearing from an anchor + known distances.' That's how audiation works at every level." }
      ],
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Three-note phrase audiation: hear a short phrase using A, C, and D — maybe A-C-D or D-C-A — in your head for a full bar (4 beats). Hold the whole phrase internally, not just the first note. Then sing it in the next bar. How close was it? Try 4 times.", why: "Hearing a SEQUENCE internally is the leap from single-note audiation to melodic audiation (Gordon Stage 6). Your inner ear must hold multiple notes in order — pitch AND sequence AND rhythm. This is how melodies 'come to you' — they form inside before they come out." },
        ...
        { text: "Full pentatonic audiation: all five notes (A, C, D, E, G) available on your inner canvas. Hear a phrase — any length, any rhythm — for a full bar of silence. Then sing it. The goal isn't perfection; it's the ATTEMPT to hear before singing. Even a rough match means your audiation is working. 2 minutes. Record it.", why: "Five-note audiation is the bridge to Level 5's full-scale audiation. Aarhus 2021 imaging shows that the auditory cortex is MORE active during imagined music than during passive listening — your brain is working harder in the silent bars than in the singing bars. This is the deepest practice you can do." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Expand to three-note responses (A, C, D). Guitar calls with 2-3 notes, 2 bars of silent audiation where you hear your response forming, then sing. The responses should RELATE to the call — answer its contour, complement its rhythm, complete its thought. But the response must be heard internally before it's sung.", why: "Three-note responses increase the audiation load while the conversational context keeps it musical. Your inner ear must now compose a response that's both musically relevant AND pre-heard — two cognitive tasks at once. This is how improvising musicians actually think." },
        { text: "Full pentatonic responses. Guitar calls use all five Am pentatonic notes. In the 2 silent bars, hear a pentatonic response — its notes, its rhythm, its shape. Then sing exactly what you heard. It's okay if the sung version isn't perfect — the goal is the ATTEMPT to pre-hear. 2 minutes.", why: "Full pentatonic audiated conversation is the synthesis of every audiation skill in L3 and L4: internal hearing (ss-3-8), multi-note audiation (ss-4-21), and call-and-response (ss-4-3/ss-4-6). When you can hear a five-note response before singing it, you're improvising the way professionals do." },
