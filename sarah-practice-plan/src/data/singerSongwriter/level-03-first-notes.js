...
export const level3 = {
  ...
  exercises: [
...

    {
      ...
      wrong: "If you're drifting off pitch or can't feel the lock with the drone, try the body approach: feel where the note lives physically — the warmth in your chest — and let that sensation guide your voice to the pitch. If you're matching the pitch but it feels empty, add the emotional layer: what does this note WANT to express right now? The full cycle is hear-feel-choose-sing. If any channel has gone dark, slow down and re-engage it.",
