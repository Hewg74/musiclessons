  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Sing an original melody at a relaxed tempo. Porch register. Don't project. Feel how the body balances two intimate instruments — the fingertips and the vocal cords — both producing sound that passes through the body before it reaches the air. Let the fingerpicking be louder than your voice. Guitar and voice breathe together.", why: "Fingerpicking + quiet voice is the Singer-Songwriter Aesthetic. Think Nick Drake — the guitar is prominent, the voice is intimate." },
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Add index finger: pinch the 2nd string (B) with your thumb-strike on the 5th string. Then thumb plays 4th string alone. Pattern: Pinch-Thumb-Pinch-Thumb. Feel the pinch as a simultaneous event — two points of contact, two vibrations entering the body at once.", why: "The pinch (thumb + finger together) is the backbone of Travis picking. It emphasizes beat 1 while the bass walks." },
