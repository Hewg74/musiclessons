...
export const level6 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      sarah: "Gene, this exercise is sneaky powerful. By holding still while the chords move, you're training your ear to hear how harmony WORKS — how the same note means different things in different contexts. This is the foundation of writing melodies that interact with chords. Once E across Am-C-G-Em feels natural, tap 'Draw new progression' below and try the same still-voice trick over a fifties doo-wop or cyclic-minor. Same body, new harmony rotating beneath. Allah-Las do exactly this.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
...

    {
      ...
      sarah: "Gene, Am-C-G is the backbone of so many surf-psych songs. This three-chord motion is in your DNA — let your voice discover how it naturally wants to navigate it. Tap 'Draw new progression' below after each run — a dorian i-IV feels different than a minor i-iv-v, which feels different than a three-chord major. Same voice-over-three-chords skill, different harmonic worlds. That's how Khruangbin's bass motion stays interesting.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
...

    {
      ...
      sarah: "Gene, Khruangbin's vocal lines are the definition of smooth voice leading — Laura's voice barely moves while the chords shift underneath. That effortless, flowing quality is exactly what this exercise builds. Tap 'Draw new progression' below after mastering Am-C-G-Em. The voice-leading skill isn't 'find the nearest tone in THIS progression' — it's the instinct itself. Prove it by stepping smoothly through a minor descent, a cyclic minor, a jangle. Laura Lee does this in every key Khruangbin writes in.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
        pool: ["minor_three", "minor_descent", "minor_uplift", "minor_cyclic"],
...

    {
      ...
      sarah: "Gene, this is Pepper and Slightly Stoopid territory — your SoCal reggae-rock roots. The offbeat chop is in your muscle memory. Now let your voice learn to ride that groove. Tap 'Draw new progression' below — same reggae chop pattern, different harmonies. A one-chord Marley vamp, a Dorian groove, an i-IV cycle. Reggae singers don't need fancy changes — they need pocket over anything. Prove it.",
      chordProgression: {
        key: "A",
        scale: "natural-minor",
        pool: ["minor_three", "minor_cyclic", "desert_vamp", "desert_blues"],
      },
      metronome: 85,
      referencePitches: getPitchRange("A2", "E4"),
      recorder: true
    },
    {
      ...
      chordProgression: {
        key: "G",
        scale: "major",
        pool: ["jangle", "pop_axis", "pop_vi_iv_i_v", "fifties_doowop"],
      },
      ...
      sarah: "Gene, this is Allah-Las and Mystic Braves territory. Your surf-psych core. The jangle strum is in your hands — now your voice learns to build and crest over it like a wave. Tap 'Draw new progression' below after G-Em-C-D feels natural — a Smiths-style jangle (I-iii-vi-IV), a vi-IV-I-V anthem, a doo-wop loop. Same jangle strum, same dynamic arc, new chord journey. That's how Allah-Las wrote so many songs that sound similar without being repeats.",
      metronome: 90,
      referencePitches: getPitchRange("E3", "D4"),
      pitchContour: true,
      volumeMeter: true,
