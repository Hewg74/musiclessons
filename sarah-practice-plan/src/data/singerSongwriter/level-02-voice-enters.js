...
export const level2 = {
  ...
  exercises: [
    ...
    },
    {
      ...
      steps: [
        { text: "Start strumming. Before each contour, close your eyes for one bar and imagine the shape you want to hum — rising, falling, arching. Hear the contour in your mind's ear before your voice traces it. Then hum any melody contour over the chord progression — approximate, not perfect.", why: "Imagining the shape before you sing it trains your inner ear to lead. Humming is easier than singing because there are no words to coordinate — and pre-hearing the contour makes it even smoother." },
    ...
    },
    {
      ...
      steps: [
        { text: "Strum G. Before you sing, hear the root G in your head — let your brain arrive at the pitch before your voice does. Sing the root G for 2 beats, then imagine the 5th D before singing it for 2 beats. Use 'ooh' or 'la.' Find the D on the open D string if you need a reference.", why: "Pre-hearing each note trains your inner ear to lead your voice. Root and 5th are the two strongest, most consonant notes in any chord. They always sound right — zero risk of clashing." },
