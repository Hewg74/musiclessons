...
import { playWarmNote, LivePitchDetector, normalizeNote, getColorForNote } from './JungleTools.jsx';
    ...
    <div style={{
      ...
      {phase === 'playing' && (
        <div style={{ animation: 'phFadeIn 0.4s ease-out' }}>
          ...
          {/* LivePitchDetector — hidden but active for matching levels */}
          {(ldef.type === 'match' || ldef.type === 'broken') && (
            <div style={{ position: 'fixed', bottom: -200, left: -200, opacity: 0, pointerEvents: 'none' }}>
              <LivePitchDetector
                theme={T}
                inline={true}
